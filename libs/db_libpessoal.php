...
function db_verifica_dias_trabalhados($regist, $ano, $mes, $dias_trab = false){
  ...
  if($dias_trab == false){
    $result_testa_ferias = pg_exec("select dias_gozo_ferias(".$regist.",".$ano.",".$mes.",".$dias_mes.",".db_getsession("DB_instit").") as dias_ferias");
    ...
    $result_testa_afasta = pg_exec("select conta_dias_afasta(".$regist.",".$ano.",".$mes.",".$dias_mes.",".db_getsession("DB_instit").") as  dias_afasta");
    ...
    $result_testa_rescis = pg_exec("select rh05_recis as data_recis
                                    from rhpesrescisao 
    ...
    $result_dias_trab = pg_exec("select fc_dias_trabalhados(".$regist.",".$ano.",".$mes.",true,".db_getsession("DB_instit").") as dias_pagamento");
  ...
  $result_nome_funcionario = pg_exec(
...
function bb_condicaosubpesproc($prefixo=null,$subpes_procesamento=null,$instit=''){
...
//  $retorno .= "  and  "+$prefixo+ "mesusu = "+db_mesfolha();
  ...
  if(db_at(strtoupper($prefixo),"R45_R61_R30_R51_R05_R12_R03_R27_R57_R42_R25_R28_R41_R52_R63_R17_R60_R64_R65_R37_R66_R67_") == 0 ){
     $retorno .= "  and  ".$prefixo."instit = ".$instit;
  }   
  return $retorno;
...
//exit;
     $retorno = pg_query($monta_string." as ".$asSQL);
   }
