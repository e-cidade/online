...
class cl_translan extends cl_contranslan {
  ...
  */
  function db_trans_suplem($anousu, $tipo, $red = false, $lSuplementacaoEspecial = false) {
...
//                if (substr($estrutural,0,3) == "497") {
      ...
      function calcula_rcl2($anousu, $dtini, $dtfin, $db_selinstit, $matriz = false, $codrel = 5,$data = 0) {
        ...
        global $o57_fonte, $janeiro, $fevereiro, 
               $marco, $abril, $maio, $junho, $julho, $agosto, $setembro, $outubro, $novembro, $dezembro, $bimestre, $dt;
...
function duplicaReceitaaCorrenteLiquida($iAnoUsu, $iCodigoRelatorio) {
  ...
  $sSqlApagaPadrao  = $oDaoFiltroPadrao->excluir(null, 
                                                 "o132_anousu = {$iExercAnt} 
                                                  and o132_orcparamrel = {$iCodigoRelatorio}");
  $sSqlinclui       = $oDaoFiltroPadrao->sql_query_file(null,"*",
                                                       null,
  ...
  $sSqlApagaOrcamento  = $oDaoFiltroUsuario->excluir(null, 
                                                 "o133_anousu = {$iExercAnt} 
                                                  and o133_orcparamrel = {$iCodigoRelatorio}");
  $sSqlinclui       = $oDaoFiltroUsuario->sql_query_file(null,"*",
                                                       null,
