...
if (isset($pesquisa)){
	...
	if($linhas>0){
		echo"
		<script>
			location.href='itbi_principalurbano.php?cnpj=$cnpj&tipo=rural&sol=$solicitante';
		</script>
		";
	}else{
	...
	<form name="form1" method="post" action="">
	    <table width="60%" border="0"  cellpadding="5" cellspacing="0" class="texto" align="center">
	    	...
	    	<tr>
              ...
              <input name="cnpj" type="text" size="18" maxlength="18"
                  onKeyPress='FormataCPFeCNPJ(this,event); return js_teclas(event);'>
	            </td>
	        </tr>
	        <tr>
	            <td width="50%" height="30" align="right">Solicitante:&nbsp;
	            </td>
	            <td width="50%" height="30"> 
	            	<select name="solicitante"  >
     	  	 			<option value='t'>Transmitente</option>
