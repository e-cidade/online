...
//####################################################################
	if($tipo=="urbano"){ echo"xxxxxxxxxxxxxxx";
 // inclui na itburbano ...........................................   	
		       		...
		       		for($i=0;$i<$linhascar;$i++){
				       	...
				       	if($par_impar=="0"){
				       		...
				       		<tr>
					       		...
					       		<td width='25%'><input name='j31_descr$i' type='text' size='10' value='0'></td>";
				       	}
				       	if($par_impar=="1"){
							echo"				       	
								<td width='25%'>$j31_descr</td> 
