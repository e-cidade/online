...
if(isset($certid)){
  $sql = " 
         select v01_coddiv,v01_numcgm,z01_nome,v01_dtinsc,v01_exerc,v01_numpre,v01_numpar,v01_proced,v03_descr,v01_numtot,v01_numdig,v01_vlrhis,v01_obs   ,v01_livro ,v01_folha ,v01_dtvenc,v01_dtoper,v01_valor
	   from certdiv 
         	inner join divida  on  divida.v01_coddiv = certdiv.v14_coddiv
		inner join arrecad on  divida.v01_numpre = arrecad.k00_numpre and divida.v01_numpar = arrecad.k00_numpar
        ...
        ";
  $sql02 = " 
         select distinct v01_exerc,v01_proced,v03_descr,v01_numpre
	      from certdiv 
         	inner join divida  on  divida.v01_coddiv = certdiv.v14_coddiv
		inner join arrecad on  divida.v01_numpre = arrecad.k00_numpre and divida.v01_numpar = arrecad.k00_numpar
		inner join proced  on  divida.v01_proced = proced.v03_codigo 
  ...
  for($i=0; $i<$numrows02; $i++){
   ...
   $otal='';
    db_fieldsmemory($result02,$i);
     $result05=debitos_numpre($v01_numpre,0,$tipo,db_getsession("DB_datausu"),db_getsession("DB_anousu"));
