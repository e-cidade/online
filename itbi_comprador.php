...
<table width="770px" border="0" cellspacing="2" cellpadding="2" align="center">
	...
	echo "
		<script>
			document.form1.it03_nome.value    = '$z01_nome';
			document.form1.it03_sexo.value    = '$z01_sexo';
			document.form1.it03_cpfcnpj.value = '$z01_cgccpf';
			document.form1.it03_endereco.value= '$z01_ender';
			document.form1.it03_numero.value  = '$z01_numero';
			document.form1.it03_compl.value   = '$z01_compl';
			document.form1.it03_cxpostal.value= '$z01_cxpostal';
			document.form1.it03_bairro.value  = '$z01_bairro';
			document.form1.it03_munic.value   = '$z01_munic';
			document.form1.it03_uf.value      = '$z01_uf';
			document.form1.it03_cep.value     = '$z01_cep';
			document.form1.it03_mail.value    = '$z01_email';
				
		</script>
	";
	}else{
		msgbox("nenhum registro encontrado para este CPF/CNPJ");	
	}
}
  			
  			
				if($cod!=""){
					$sql= "select * from itbinome where it03_guia=$cod and it03_tipo='c'";
					$result = pg_query($sql);
