...
<table height="100%" border="0"  align="center" cellspacing="0" bgcolor="#CCCCCC">
     ...
     ?>
          ...
          <tr> 
            <td colspan="2" align="center"> 
              ...
              <input name="Fechar" type="button" id="fechar" value="Fechar" onClick="parent.db_iframe_ativid.hide();">
             </td>
          </tr>
        </form>
        </table>
  ...
  <tr> 
    <td align="center" valign="top"> 
      ...
      $campos = "q03_ativ, q03_descr, q12_descr";
      ...
      if( isset($tipo_pesquisa) && $tipo_pesquisa == 'cnpj'){
        ...
        $where = "(q03_limite is null) and q12_fisica is true ";

        $campos .= ", q71_estrutural";
        
        if(!isset($pesquisa_chave)){
                       
          if(isset($chave_q03_ativ) && (trim($chave_q03_ativ)!="") ){
             $sql = $clativid->sql_query_cnaeSimulacao($chave_q03_ativ,$campos,"q03_ativ","$where and  q03_ativ = $chave_q03_ativ");
             //die($sql);
          }else if(isset($chave_q03_descr) && (trim($chave_q03_descr)!="") ){
             $sql = $clativid->sql_query_cnaeSimulacao("",$campos,"q03_descr"," q03_descr like '$chave_q03_descr%' and  $where");
          }else if(isset($chave_q71_estrutural) && (trim($chave_q71_estrutural)!="") ){
             $sql = $clativid->sql_query_cnaeSimulacao("",$campos,"q71_estrutural"," q71_estrutural like '%$chave_q71_estrutural%' and  $where");
          }else{
             $sql = $clativid->sql_query_cnaeSimulacao("",$campos,"q03_ativ","$where");
          }
