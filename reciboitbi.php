...
$result = pg_exec($conn,"select db_itbi.*,to_char(datavencimento,'DD-MM-YYYY') as datavenctochar
                       from db_itbi
    				   where id_itbi = ".$itbi);
...
$proprietarios = '';
$resultprop = pg_exec($conn,"select *
...
$resultcod = pg_exec("select fc_febraban('816'||'$vlrbar'||'".$numbanco."'||'0000'||$dtvenc||'00'||'$numpre')");
