...
class cl_cancdebitosissplan { 
   ...
   function incluir ($q78_sequencial){ 
     ...
     if($q78_sequencial == "" || $q78_sequencial == null ){
       $result = @pg_query("select nextval('cancdebitosissplan_q78_sequencial_seq')"); 
       if($result==false){
       ...
       $result = @pg_query("select last_value from cancdebitosissplan_q78_sequencial_seq");
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = pg_query("insert into db_acountkey values($acount,12002,'$this->q78_sequencial','I')");
       $resac = pg_query("insert into db_acount values($acount,2076,12002,'','".AddSlashes(pg_result($resaco,0,'q78_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,2076,12003,'','".AddSlashes(pg_result($resaco,0,'q78_cancdebitos'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,2076,12004,'','".AddSlashes(pg_result($resaco,0,'q78_issplan'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($q78_sequencial=null) { 
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         $resac = pg_query("select nextval('db_acount_id_acount_seq') as acount");
         $acount = pg_result($resac,0,0);
         $resac = pg_query("insert into db_acountkey values($acount,12002,'$this->q78_sequencial','A')");
         if(isset($GLOBALS["HTTP_POST_VARS"]["q78_sequencial"]))
           $resac = pg_query("insert into db_acount values($acount,2076,12002,'".AddSlashes(pg_result($resaco,$conresaco,'q78_sequencial'))."','$this->q78_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["q78_cancdebitos"]))
           $resac = pg_query("insert into db_acount values($acount,2076,12003,'".AddSlashes(pg_result($resaco,$conresaco,'q78_cancdebitos'))."','$this->q78_cancdebitos',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["q78_issplan"]))
           $resac = pg_query("insert into db_acount values($acount,2076,12004,'".AddSlashes(pg_result($resaco,$conresaco,'q78_issplan'))."','$this->q78_issplan',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = @pg_exec($sql);
     if($result==false){ 
   ...
   function excluir ($q78_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         $resac = pg_query("select nextval('db_acount_id_acount_seq') as acount");
         $acount = pg_result($resac,0,0);
         $resac = pg_query("insert into db_acountkey values($acount,12002,'$q78_sequencial','E')");
         $resac = pg_query("insert into db_acount values($acount,2076,12002,'','".AddSlashes(pg_result($resaco,$iresaco,'q78_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,2076,12003,'','".AddSlashes(pg_result($resaco,$iresaco,'q78_cancdebitos'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,2076,12004,'','".AddSlashes(pg_result($resaco,$iresaco,'q78_issplan'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
