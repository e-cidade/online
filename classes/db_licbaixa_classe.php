...
class cl_licbaixa { 
   ...
   function incluir ($l28_sequencial){ 
     ...
     if($l28_sequencial == "" || $l28_sequencial == null ){
       $result = @pg_query("select nextval('licbaixa_l28_sequencial_seq')"); 
       if($result==false){
       ...
       $result = @pg_query("select last_value from licbaixa_l28_sequencial_seq");
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = pg_query("insert into db_acountkey values($acount,9400,'$this->l28_sequencial','I')");
       $resac = pg_query("insert into db_acount values($acount,1616,9400,'','".AddSlashes(pg_result($resaco,0,'l28_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,1616,9401,'','".AddSlashes(pg_result($resaco,0,'l28_nome'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,1616,9402,'','".AddSlashes(pg_result($resaco,0,'l28_cnpj'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,1616,9403,'','".AddSlashes(pg_result($resaco,0,'l28_email'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,1616,9404,'','".AddSlashes(pg_result($resaco,0,'l28_endereco'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,1616,9405,'','".AddSlashes(pg_result($resaco,0,'l28_cidade'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,1616,9406,'','".AddSlashes(pg_result($resaco,0,'l28_fone'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,1616,9407,'','".AddSlashes(pg_result($resaco,0,'l28_data'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,1616,9408,'','".AddSlashes(pg_result($resaco,0,'l28_hora'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,1616,9409,'','".AddSlashes(pg_result($resaco,0,'l28_ip'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,1616,9420,'','".AddSlashes(pg_result($resaco,0,'l28_liclicita'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($l28_sequencial=null) { 
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         $resac = pg_query("select nextval('db_acount_id_acount_seq') as acount");
         $acount = pg_result($resac,0,0);
         $resac = pg_query("insert into db_acountkey values($acount,9400,'$this->l28_sequencial','A')");
         if(isset($GLOBALS["HTTP_POST_VARS"]["l28_sequencial"]))
           $resac = pg_query("insert into db_acount values($acount,1616,9400,'".AddSlashes(pg_result($resaco,$conresaco,'l28_sequencial'))."','$this->l28_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["l28_nome"]))
           $resac = pg_query("insert into db_acount values($acount,1616,9401,'".AddSlashes(pg_result($resaco,$conresaco,'l28_nome'))."','$this->l28_nome',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["l28_cnpj"]))
           $resac = pg_query("insert into db_acount values($acount,1616,9402,'".AddSlashes(pg_result($resaco,$conresaco,'l28_cnpj'))."','$this->l28_cnpj',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["l28_email"]))
           $resac = pg_query("insert into db_acount values($acount,1616,9403,'".AddSlashes(pg_result($resaco,$conresaco,'l28_email'))."','$this->l28_email',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["l28_endereco"]))
           $resac = pg_query("insert into db_acount values($acount,1616,9404,'".AddSlashes(pg_result($resaco,$conresaco,'l28_endereco'))."','$this->l28_endereco',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["l28_cidade"]))
           $resac = pg_query("insert into db_acount values($acount,1616,9405,'".AddSlashes(pg_result($resaco,$conresaco,'l28_cidade'))."','$this->l28_cidade',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["l28_fone"]))
           $resac = pg_query("insert into db_acount values($acount,1616,9406,'".AddSlashes(pg_result($resaco,$conresaco,'l28_fone'))."','$this->l28_fone',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["l28_data"]))
           $resac = pg_query("insert into db_acount values($acount,1616,9407,'".AddSlashes(pg_result($resaco,$conresaco,'l28_data'))."','$this->l28_data',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["l28_hora"]))
           $resac = pg_query("insert into db_acount values($acount,1616,9408,'".AddSlashes(pg_result($resaco,$conresaco,'l28_hora'))."','$this->l28_hora',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["l28_ip"]))
           $resac = pg_query("insert into db_acount values($acount,1616,9409,'".AddSlashes(pg_result($resaco,$conresaco,'l28_ip'))."','$this->l28_ip',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["l28_liclicita"]))
           $resac = pg_query("insert into db_acount values($acount,1616,9420,'".AddSlashes(pg_result($resaco,$conresaco,'l28_liclicita'))."','$this->l28_liclicita',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = @pg_exec($sql);
     if($result==false){ 
   ...
   function excluir ($l28_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         $resac = pg_query("select nextval('db_acount_id_acount_seq') as acount");
         $acount = pg_result($resac,0,0);
         $resac = pg_query("insert into db_acountkey values($acount,9400,'$l28_sequencial','E')");
         $resac = pg_query("insert into db_acount values($acount,1616,9400,'','".AddSlashes(pg_result($resaco,$iresaco,'l28_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,1616,9401,'','".AddSlashes(pg_result($resaco,$iresaco,'l28_nome'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,1616,9402,'','".AddSlashes(pg_result($resaco,$iresaco,'l28_cnpj'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,1616,9403,'','".AddSlashes(pg_result($resaco,$iresaco,'l28_email'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,1616,9404,'','".AddSlashes(pg_result($resaco,$iresaco,'l28_endereco'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,1616,9405,'','".AddSlashes(pg_result($resaco,$iresaco,'l28_cidade'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,1616,9406,'','".AddSlashes(pg_result($resaco,$iresaco,'l28_fone'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,1616,9407,'','".AddSlashes(pg_result($resaco,$iresaco,'l28_data'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,1616,9408,'','".AddSlashes(pg_result($resaco,$iresaco,'l28_hora'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,1616,9409,'','".AddSlashes(pg_result($resaco,$iresaco,'l28_ip'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,1616,9420,'','".AddSlashes(pg_result($resaco,$iresaco,'l28_liclicita'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
