   ...
   function incluir ($w07_codigo,$w07_item){ 
    ...
    // }
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = pg_query("insert into db_acountkey values($acount,4649,'$this->w07_codigo','I')");
       $resac = pg_query("insert into db_acountkey values($acount,4650,'$this->w07_item','I')");
       $resac = pg_query("insert into db_acount values($acount,610,4649,'','".AddSlashes(pg_result($resaco,0,'w07_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,610,4650,'','".AddSlashes(pg_result($resaco,0,'w07_item'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,610,4651,'','".AddSlashes(pg_result($resaco,0,'w07_mes'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,610,4652,'','".AddSlashes(pg_result($resaco,0,'w07_valor'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,610,4653,'','".AddSlashes(pg_result($resaco,0,'w07_aliquota'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,610,4654,'','".AddSlashes(pg_result($resaco,0,'w07_imposto'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,610,4725,'','".AddSlashes(pg_result($resaco,0,'w07_dtpaga'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($w07_codigo=null,$w07_item=null) { 
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         $resac = pg_query("select nextval('db_acount_id_acount_seq') as acount");
         $acount = pg_result($resac,0,0);
         $resac = pg_query("insert into db_acountkey values($acount,4649,'$this->w07_codigo','A')");
         $resac = pg_query("insert into db_acountkey values($acount,4650,'$this->w07_item','A')");
         if(isset($GLOBALS["HTTP_POST_VARS"]["w07_codigo"]))
           $resac = pg_query("insert into db_acount values($acount,610,4649,'".AddSlashes(pg_result($resaco,$conresaco,'w07_codigo'))."','$this->w07_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["w07_item"]))
           $resac = pg_query("insert into db_acount values($acount,610,4650,'".AddSlashes(pg_result($resaco,$conresaco,'w07_item'))."','$this->w07_item',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["w07_mes"]))
           $resac = pg_query("insert into db_acount values($acount,610,4651,'".AddSlashes(pg_result($resaco,$conresaco,'w07_mes'))."','$this->w07_mes',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["w07_valor"]))
           $resac = pg_query("insert into db_acount values($acount,610,4652,'".AddSlashes(pg_result($resaco,$conresaco,'w07_valor'))."','$this->w07_valor',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["w07_aliquota"]))
           $resac = pg_query("insert into db_acount values($acount,610,4653,'".AddSlashes(pg_result($resaco,$conresaco,'w07_aliquota'))."','$this->w07_aliquota',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["w07_imposto"]))
           $resac = pg_query("insert into db_acount values($acount,610,4654,'".AddSlashes(pg_result($resaco,$conresaco,'w07_imposto'))."','$this->w07_imposto',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["w07_dtpaga"]))
           $resac = pg_query("insert into db_acount values($acount,610,4725,'".AddSlashes(pg_result($resaco,$conresaco,'w07_dtpaga'))."','$this->w07_dtpaga',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = @pg_exec($sql);
     if($result==false){ 
   ...
   function excluir ($w07_codigo=null,$w07_item=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         $resac = pg_query("select nextval('db_acount_id_acount_seq') as acount");
         $acount = pg_result($resac,0,0);
         $resac = pg_query("insert into db_acountkey values($acount,4649,'$w07_codigo','E')");
         $resac = pg_query("insert into db_acountkey values($acount,4650,'$w07_item','E')");
         $resac = pg_query("insert into db_acount values($acount,610,4649,'','".AddSlashes(pg_result($resaco,$iresaco,'w07_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,610,4650,'','".AddSlashes(pg_result($resaco,$iresaco,'w07_item'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,610,4651,'','".AddSlashes(pg_result($resaco,$iresaco,'w07_mes'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,610,4652,'','".AddSlashes(pg_result($resaco,$iresaco,'w07_valor'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,610,4653,'','".AddSlashes(pg_result($resaco,$iresaco,'w07_aliquota'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,610,4654,'','".AddSlashes(pg_result($resaco,$iresaco,'w07_imposto'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,610,4725,'','".AddSlashes(pg_result($resaco,$iresaco,'w07_dtpaga'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
