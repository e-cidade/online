...
class cl_arreold { 
   ...
   function atualizacampos($exclusao=false) {
     if($exclusao==false){
       ...
       if($this->k00_dtoper == ""){
         $this->k00_dtoper_dia = @$GLOBALS["HTTP_POST_VARS"]["k00_dtoper_dia"];
         $this->k00_dtoper_mes = @$GLOBALS["HTTP_POST_VARS"]["k00_dtoper_mes"];
         $this->k00_dtoper_ano = @$GLOBALS["HTTP_POST_VARS"]["k00_dtoper_ano"];
       ...
       if($this->k00_dtvenc == ""){
         $this->k00_dtvenc_dia = @$GLOBALS["HTTP_POST_VARS"]["k00_dtvenc_dia"];
         $this->k00_dtvenc_mes = @$GLOBALS["HTTP_POST_VARS"]["k00_dtvenc_mes"];
         $this->k00_dtvenc_ano = @$GLOBALS["HTTP_POST_VARS"]["k00_dtvenc_ano"];
