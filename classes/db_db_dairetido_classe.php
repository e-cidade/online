...
class cl_db_dairetido { 
   ...
   function incluir ($w15_sequencial){ 
     ...
     if($w15_sequencial == "" || $w15_sequencial == null ){
       $result = @pg_query("select nextval('db_dairetido_w15_sequencial_seq')"); 
       if($result==false){
       ...
       $result = @pg_query("select last_value from db_dairetido_w15_sequencial_seq");
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = pg_query("insert into db_acountkey values($acount,9131,'$this->w15_sequencial','I')");
       $resac = pg_query("insert into db_acount values($acount,1563,9131,'','".AddSlashes(pg_result($resaco,0,'w15_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,1563,9132,'','".AddSlashes(pg_result($resaco,0,'w15_dai'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,1563,9133,'','".AddSlashes(pg_result($resaco,0,'w15_mes'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,1563,9135,'','".AddSlashes(pg_result($resaco,0,'w15_valreceita'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,1563,9137,'','".AddSlashes(pg_result($resaco,0,'w15_cnpj'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,1563,9175,'','".AddSlashes(pg_result($resaco,0,'w15_nota'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,1563,9176,'','".AddSlashes(pg_result($resaco,0,'w15_serie'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,1563,9177,'','".AddSlashes(pg_result($resaco,0,'w15_data'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($w15_sequencial=null) { 
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         $resac = pg_query("select nextval('db_acount_id_acount_seq') as acount");
         $acount = pg_result($resac,0,0);
         $resac = pg_query("insert into db_acountkey values($acount,9131,'$this->w15_sequencial','A')");
         if(isset($GLOBALS["HTTP_POST_VARS"]["w15_sequencial"]))
           $resac = pg_query("insert into db_acount values($acount,1563,9131,'".AddSlashes(pg_result($resaco,$conresaco,'w15_sequencial'))."','$this->w15_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["w15_dai"]))
           $resac = pg_query("insert into db_acount values($acount,1563,9132,'".AddSlashes(pg_result($resaco,$conresaco,'w15_dai'))."','$this->w15_dai',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["w15_mes"]))
           $resac = pg_query("insert into db_acount values($acount,1563,9133,'".AddSlashes(pg_result($resaco,$conresaco,'w15_mes'))."','$this->w15_mes',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["w15_valreceita"]))
           $resac = pg_query("insert into db_acount values($acount,1563,9135,'".AddSlashes(pg_result($resaco,$conresaco,'w15_valreceita'))."','$this->w15_valreceita',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["w15_cnpj"]))
           $resac = pg_query("insert into db_acount values($acount,1563,9137,'".AddSlashes(pg_result($resaco,$conresaco,'w15_cnpj'))."','$this->w15_cnpj',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["w15_nota"]))
           $resac = pg_query("insert into db_acount values($acount,1563,9175,'".AddSlashes(pg_result($resaco,$conresaco,'w15_nota'))."','$this->w15_nota',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["w15_serie"]))
           $resac = pg_query("insert into db_acount values($acount,1563,9176,'".AddSlashes(pg_result($resaco,$conresaco,'w15_serie'))."','$this->w15_serie',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["w15_data"]))
           $resac = pg_query("insert into db_acount values($acount,1563,9177,'".AddSlashes(pg_result($resaco,$conresaco,'w15_data'))."','$this->w15_data',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = @pg_exec($sql);
     if($result==false){ 
   ...
   function excluir ($w15_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         $resac = pg_query("select nextval('db_acount_id_acount_seq') as acount");
         $acount = pg_result($resac,0,0);
         $resac = pg_query("insert into db_acountkey values($acount,9131,'$w15_sequencial','E')");
         $resac = pg_query("insert into db_acount values($acount,1563,9131,'','".AddSlashes(pg_result($resaco,$iresaco,'w15_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,1563,9132,'','".AddSlashes(pg_result($resaco,$iresaco,'w15_dai'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,1563,9133,'','".AddSlashes(pg_result($resaco,$iresaco,'w15_mes'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,1563,9135,'','".AddSlashes(pg_result($resaco,$iresaco,'w15_valreceita'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,1563,9137,'','".AddSlashes(pg_result($resaco,$iresaco,'w15_cnpj'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,1563,9175,'','".AddSlashes(pg_result($resaco,$iresaco,'w15_nota'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,1563,9176,'','".AddSlashes(pg_result($resaco,$iresaco,'w15_serie'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,1563,9177,'','".AddSlashes(pg_result($resaco,$iresaco,'w15_data'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
