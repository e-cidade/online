...
class cl_issplananula { 
   ...
   function incluir ($q76_sequencial){ 
     ...
     if($q76_sequencial == "" || $q76_sequencial == null ){
       $result = @pg_query("select nextval('issplananula_q76_sequencial_seq')"); 
       if($result==false){
       ...
       $result = @pg_query("select last_value from issplananula_q76_sequencial_seq");
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = pg_query("insert into db_acountkey values($acount,11987,'$this->q76_sequencial','I')");
       $resac = pg_query("insert into db_acount values($acount,2074,11987,'','".AddSlashes(pg_result($resaco,0,'q76_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,2074,11988,'','".AddSlashes(pg_result($resaco,0,'q76_planilha'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,2074,11989,'','".AddSlashes(pg_result($resaco,0,'q76_data'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,2074,11990,'','".AddSlashes(pg_result($resaco,0,'q76_hora'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,2074,11991,'','".AddSlashes(pg_result($resaco,0,'q76_motivo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,2074,11993,'','".AddSlashes(pg_result($resaco,0,'q76_ip'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,2074,11992,'','".AddSlashes(pg_result($resaco,0,'q76_id_usuario'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($q76_sequencial=null) { 
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         $resac = pg_query("select nextval('db_acount_id_acount_seq') as acount");
         $acount = pg_result($resac,0,0);
         $resac = pg_query("insert into db_acountkey values($acount,11987,'$this->q76_sequencial','A')");
         if(isset($GLOBALS["HTTP_POST_VARS"]["q76_sequencial"]))
           $resac = pg_query("insert into db_acount values($acount,2074,11987,'".AddSlashes(pg_result($resaco,$conresaco,'q76_sequencial'))."','$this->q76_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["q76_planilha"]))
           $resac = pg_query("insert into db_acount values($acount,2074,11988,'".AddSlashes(pg_result($resaco,$conresaco,'q76_planilha'))."','$this->q76_planilha',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["q76_data"]))
           $resac = pg_query("insert into db_acount values($acount,2074,11989,'".AddSlashes(pg_result($resaco,$conresaco,'q76_data'))."','$this->q76_data',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["q76_hora"]))
           $resac = pg_query("insert into db_acount values($acount,2074,11990,'".AddSlashes(pg_result($resaco,$conresaco,'q76_hora'))."','$this->q76_hora',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["q76_motivo"]))
           $resac = pg_query("insert into db_acount values($acount,2074,11991,'".AddSlashes(pg_result($resaco,$conresaco,'q76_motivo'))."','$this->q76_motivo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["q76_ip"]))
           $resac = pg_query("insert into db_acount values($acount,2074,11993,'".AddSlashes(pg_result($resaco,$conresaco,'q76_ip'))."','$this->q76_ip',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["q76_id_usuario"]))
           $resac = pg_query("insert into db_acount values($acount,2074,11992,'".AddSlashes(pg_result($resaco,$conresaco,'q76_id_usuario'))."','$this->q76_id_usuario',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = @pg_exec($sql);
     if($result==false){ 
   ...
   function excluir ($q76_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         $resac = pg_query("select nextval('db_acount_id_acount_seq') as acount");
         $acount = pg_result($resac,0,0);
         $resac = pg_query("insert into db_acountkey values($acount,11987,'$q76_sequencial','E')");
         $resac = pg_query("insert into db_acount values($acount,2074,11987,'','".AddSlashes(pg_result($resaco,$iresaco,'q76_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,2074,11988,'','".AddSlashes(pg_result($resaco,$iresaco,'q76_planilha'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,2074,11989,'','".AddSlashes(pg_result($resaco,$iresaco,'q76_data'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,2074,11990,'','".AddSlashes(pg_result($resaco,$iresaco,'q76_hora'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,2074,11991,'','".AddSlashes(pg_result($resaco,$iresaco,'q76_motivo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,2074,11993,'','".AddSlashes(pg_result($resaco,$iresaco,'q76_ip'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,2074,11992,'','".AddSlashes(pg_result($resaco,$iresaco,'q76_id_usuario'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
