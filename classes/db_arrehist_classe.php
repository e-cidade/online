...
class cl_arrehist { 
   ...
   function incluir ($k00_idhist){ 
     ...
     if($k00_idhist == "" || $k00_idhist == null ){
       $result = @pg_query("select nextval('arrehist_k00_idhist_seq')"); 
       if($result==false){
       ...
       $result = @pg_query("select last_value from arrehist_k00_idhist_seq");
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = pg_query("insert into db_acountkey values($acount,6848,'$this->k00_idhist','I')");
       $resac = pg_query("insert into db_acount values($acount,411,361,'','".AddSlashes(pg_result($resaco,0,'k00_numpre'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,411,362,'','".AddSlashes(pg_result($resaco,0,'k00_numpar'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,411,375,'','".AddSlashes(pg_result($resaco,0,'k00_hist'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,411,373,'','".AddSlashes(pg_result($resaco,0,'k00_dtoper'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,411,2494,'','".AddSlashes(pg_result($resaco,0,'k00_hora'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,411,2495,'','".AddSlashes(pg_result($resaco,0,'k00_id_usuario'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,411,2378,'','".AddSlashes(pg_result($resaco,0,'k00_histtxt'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,411,6847,'','".AddSlashes(pg_result($resaco,0,'k00_limithist'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,411,6848,'','".AddSlashes(pg_result($resaco,0,'k00_idhist'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($k00_idhist=null) { 
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         $resac = pg_query("select nextval('db_acount_id_acount_seq') as acount");
         $acount = pg_result($resac,0,0);
         $resac = pg_query("insert into db_acountkey values($acount,6848,'$this->k00_idhist','A')");
         if(isset($GLOBALS["HTTP_POST_VARS"]["k00_numpre"]))
           $resac = pg_query("insert into db_acount values($acount,411,361,'".AddSlashes(pg_result($resaco,$conresaco,'k00_numpre'))."','$this->k00_numpre',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["k00_numpar"]))
           $resac = pg_query("insert into db_acount values($acount,411,362,'".AddSlashes(pg_result($resaco,$conresaco,'k00_numpar'))."','$this->k00_numpar',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["k00_hist"]))
           $resac = pg_query("insert into db_acount values($acount,411,375,'".AddSlashes(pg_result($resaco,$conresaco,'k00_hist'))."','$this->k00_hist',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["k00_dtoper"]))
           $resac = pg_query("insert into db_acount values($acount,411,373,'".AddSlashes(pg_result($resaco,$conresaco,'k00_dtoper'))."','$this->k00_dtoper',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["k00_hora"]))
           $resac = pg_query("insert into db_acount values($acount,411,2494,'".AddSlashes(pg_result($resaco,$conresaco,'k00_hora'))."','$this->k00_hora',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["k00_id_usuario"]))
           $resac = pg_query("insert into db_acount values($acount,411,2495,'".AddSlashes(pg_result($resaco,$conresaco,'k00_id_usuario'))."','$this->k00_id_usuario',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["k00_histtxt"]))
           $resac = pg_query("insert into db_acount values($acount,411,2378,'".AddSlashes(pg_result($resaco,$conresaco,'k00_histtxt'))."','$this->k00_histtxt',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["k00_limithist"]))
           $resac = pg_query("insert into db_acount values($acount,411,6847,'".AddSlashes(pg_result($resaco,$conresaco,'k00_limithist'))."','$this->k00_limithist',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["k00_idhist"]))
           $resac = pg_query("insert into db_acount values($acount,411,6848,'".AddSlashes(pg_result($resaco,$conresaco,'k00_idhist'))."','$this->k00_idhist',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = @pg_exec($sql);
     if($result==false){ 
   ...
   function excluir ($k00_idhist=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         $resac = pg_query("select nextval('db_acount_id_acount_seq') as acount");
         $acount = pg_result($resac,0,0);
         $resac = pg_query("insert into db_acountkey values($acount,6848,'$k00_idhist','E')");
         $resac = pg_query("insert into db_acount values($acount,411,361,'','".AddSlashes(pg_result($resaco,$iresaco,'k00_numpre'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,411,362,'','".AddSlashes(pg_result($resaco,$iresaco,'k00_numpar'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,411,375,'','".AddSlashes(pg_result($resaco,$iresaco,'k00_hist'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,411,373,'','".AddSlashes(pg_result($resaco,$iresaco,'k00_dtoper'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,411,2494,'','".AddSlashes(pg_result($resaco,$iresaco,'k00_hora'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,411,2495,'','".AddSlashes(pg_result($resaco,$iresaco,'k00_id_usuario'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,411,2378,'','".AddSlashes(pg_result($resaco,$iresaco,'k00_histtxt'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,411,6847,'','".AddSlashes(pg_result($resaco,$iresaco,'k00_limithist'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,411,6848,'','".AddSlashes(pg_result($resaco,$iresaco,'k00_idhist'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
