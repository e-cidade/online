...
class cl_issplannumpreissplanit { 
   ...
   function incluir ($q77_sequencial){ 
     ...
     if($q77_sequencial == "" || $q77_sequencial == null ){
       $result = @pg_query("select nextval('issplannumpreissplanit_q77_sequencial_seq')"); 
       if($result==false){
       ...
       $result = @pg_query("select last_value from issplannumpreissplanit_q77_sequencial_seq");
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = pg_query("insert into db_acountkey values($acount,11984,'$this->q77_sequencial','I')");
       $resac = pg_query("insert into db_acount values($acount,2073,11984,'','".AddSlashes(pg_result($resaco,0,'q77_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,2073,11985,'','".AddSlashes(pg_result($resaco,0,'q77_issplanit'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,2073,11986,'','".AddSlashes(pg_result($resaco,0,'q77_issplannumpre'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($q77_sequencial=null) { 
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         $resac = pg_query("select nextval('db_acount_id_acount_seq') as acount");
         $acount = pg_result($resac,0,0);
         $resac = pg_query("insert into db_acountkey values($acount,11984,'$this->q77_sequencial','A')");
         if(isset($GLOBALS["HTTP_POST_VARS"]["q77_sequencial"]))
           $resac = pg_query("insert into db_acount values($acount,2073,11984,'".AddSlashes(pg_result($resaco,$conresaco,'q77_sequencial'))."','$this->q77_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["q77_issplanit"]))
           $resac = pg_query("insert into db_acount values($acount,2073,11985,'".AddSlashes(pg_result($resaco,$conresaco,'q77_issplanit'))."','$this->q77_issplanit',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["q77_issplannumpre"]))
           $resac = pg_query("insert into db_acount values($acount,2073,11986,'".AddSlashes(pg_result($resaco,$conresaco,'q77_issplannumpre'))."','$this->q77_issplannumpre',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = @pg_exec($sql);
     if($result==false){ 
   ...
   function excluir ($q77_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         $resac = pg_query("select nextval('db_acount_id_acount_seq') as acount");
         $acount = pg_result($resac,0,0);
         $resac = pg_query("insert into db_acountkey values($acount,11984,'$q77_sequencial','E')");
         $resac = pg_query("insert into db_acount values($acount,2073,11984,'','".AddSlashes(pg_result($resaco,$iresaco,'q77_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,2073,11985,'','".AddSlashes(pg_result($resaco,$iresaco,'q77_issplanit'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,2073,11986,'','".AddSlashes(pg_result($resaco,$iresaco,'q77_issplannumpre'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
