...
class cl_cancdebitosreg { 
   ...
   function incluir ($k21_sequencia){ 
     ...
     if($k21_sequencia == "" || $k21_sequencia == null ){
       $result = @pg_query("select nextval('cancdebitosreg_k21_sequencia_seq')"); 
       if($result==false){
       ...
       $result = @pg_query("select last_value from cancdebitosreg_k21_sequencia_seq");
   ...
   // echo"<br>$sql";
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = pg_query("insert into db_acountkey values($acount,7330,'$this->k21_sequencia','I')");
       $resac = pg_query("insert into db_acount values($acount,1218,7330,'','".AddSlashes(pg_result($resaco,0,'k21_sequencia'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,1218,7331,'','".AddSlashes(pg_result($resaco,0,'k21_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,1218,7332,'','".AddSlashes(pg_result($resaco,0,'k21_numpre'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,1218,7333,'','".AddSlashes(pg_result($resaco,0,'k21_numpar'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,1218,7334,'','".AddSlashes(pg_result($resaco,0,'k21_receit'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,1218,7335,'','".AddSlashes(pg_result($resaco,0,'k21_data'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,1218,7336,'','".AddSlashes(pg_result($resaco,0,'k21_hora'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,1218,7337,'','".AddSlashes(pg_result($resaco,0,'k21_obs'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($k21_sequencia=null) { 
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         $resac = pg_query("select nextval('db_acount_id_acount_seq') as acount");
         $acount = pg_result($resac,0,0);
         $resac = pg_query("insert into db_acountkey values($acount,7330,'$this->k21_sequencia','A')");
         if(isset($GLOBALS["HTTP_POST_VARS"]["k21_sequencia"]))
           $resac = pg_query("insert into db_acount values($acount,1218,7330,'".AddSlashes(pg_result($resaco,$conresaco,'k21_sequencia'))."','$this->k21_sequencia',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["k21_codigo"]))
           $resac = pg_query("insert into db_acount values($acount,1218,7331,'".AddSlashes(pg_result($resaco,$conresaco,'k21_codigo'))."','$this->k21_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["k21_numpre"]))
           $resac = pg_query("insert into db_acount values($acount,1218,7332,'".AddSlashes(pg_result($resaco,$conresaco,'k21_numpre'))."','$this->k21_numpre',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["k21_numpar"]))
           $resac = pg_query("insert into db_acount values($acount,1218,7333,'".AddSlashes(pg_result($resaco,$conresaco,'k21_numpar'))."','$this->k21_numpar',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["k21_receit"]))
           $resac = pg_query("insert into db_acount values($acount,1218,7334,'".AddSlashes(pg_result($resaco,$conresaco,'k21_receit'))."','$this->k21_receit',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["k21_data"]))
           $resac = pg_query("insert into db_acount values($acount,1218,7335,'".AddSlashes(pg_result($resaco,$conresaco,'k21_data'))."','$this->k21_data',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["k21_hora"]))
           $resac = pg_query("insert into db_acount values($acount,1218,7336,'".AddSlashes(pg_result($resaco,$conresaco,'k21_hora'))."','$this->k21_hora',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["k21_obs"]))
           $resac = pg_query("insert into db_acount values($acount,1218,7337,'".AddSlashes(pg_result($resaco,$conresaco,'k21_obs'))."','$this->k21_obs',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = @pg_exec($sql);
     if($result==false){ 
   ...
   function excluir ($k21_sequencia=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         $resac = pg_query("select nextval('db_acount_id_acount_seq') as acount");
         $acount = pg_result($resac,0,0);
         $resac = pg_query("insert into db_acountkey values($acount,7330,'$k21_sequencia','E')");
         $resac = pg_query("insert into db_acount values($acount,1218,7330,'','".AddSlashes(pg_result($resaco,$iresaco,'k21_sequencia'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,1218,7331,'','".AddSlashes(pg_result($resaco,$iresaco,'k21_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,1218,7332,'','".AddSlashes(pg_result($resaco,$iresaco,'k21_numpre'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,1218,7333,'','".AddSlashes(pg_result($resaco,$iresaco,'k21_numpar'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,1218,7334,'','".AddSlashes(pg_result($resaco,$iresaco,'k21_receit'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,1218,7335,'','".AddSlashes(pg_result($resaco,$iresaco,'k21_data'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,1218,7336,'','".AddSlashes(pg_result($resaco,$iresaco,'k21_hora'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,1218,7337,'','".AddSlashes(pg_result($resaco,$iresaco,'k21_obs'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
