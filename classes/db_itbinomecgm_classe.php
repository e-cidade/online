...
class cl_itbinomecgm { 
   ...
   function incluir ($it21_sequencial){ 
     ...
     if($it21_sequencial == "" || $it21_sequencial == null ){
       $result = @pg_query("select nextval('itbinomecgm_it21_sequencial_seq')"); 
       if($result==false){
       ...
       $result = @pg_query("select last_value from itbinomecgm_it21_sequencial_seq");
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = pg_query("insert into db_acountkey values($acount,8998,'$this->it21_sequencial','I')");
       $resac = pg_query("insert into db_acount values($acount,1539,8998,'','".AddSlashes(pg_result($resaco,0,'it21_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,1539,8999,'','".AddSlashes(pg_result($resaco,0,'it21_itbinome'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,1539,9000,'','".AddSlashes(pg_result($resaco,0,'it21_numcgm'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($it21_sequencial=null) { 
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         $resac = pg_query("select nextval('db_acount_id_acount_seq') as acount");
         $acount = pg_result($resac,0,0);
         $resac = pg_query("insert into db_acountkey values($acount,8998,'$this->it21_sequencial','A')");
         if(isset($GLOBALS["HTTP_POST_VARS"]["it21_sequencial"]))
           $resac = pg_query("insert into db_acount values($acount,1539,8998,'".AddSlashes(pg_result($resaco,$conresaco,'it21_sequencial'))."','$this->it21_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["it21_itbinome"]))
           $resac = pg_query("insert into db_acount values($acount,1539,8999,'".AddSlashes(pg_result($resaco,$conresaco,'it21_itbinome'))."','$this->it21_itbinome',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["it21_numcgm"]))
           $resac = pg_query("insert into db_acount values($acount,1539,9000,'".AddSlashes(pg_result($resaco,$conresaco,'it21_numcgm'))."','$this->it21_numcgm',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = @pg_exec($sql);
     if($result==false){ 
   ...
   function excluir ($it21_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         $resac = pg_query("select nextval('db_acount_id_acount_seq') as acount");
         $acount = pg_result($resac,0,0);
         $resac = pg_query("insert into db_acountkey values($acount,8998,'$it21_sequencial','E')");
         $resac = pg_query("insert into db_acount values($acount,1539,8998,'','".AddSlashes(pg_result($resaco,$iresaco,'it21_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,1539,8999,'','".AddSlashes(pg_result($resaco,$iresaco,'it21_itbinome'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,1539,9000,'','".AddSlashes(pg_result($resaco,$iresaco,'it21_numcgm'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
