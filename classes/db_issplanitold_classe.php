...
class cl_issplanitold { 
   ...
   function incluir ($q73_sequencial){ 
     ...
     if($q73_sequencial == "" || $q73_sequencial == null ){
       $result = @pg_query("select nextval('issplanitold_q73_sequencial_seq')"); 
       if($result==false){
       ...
       $result = @pg_query("select last_value from issplanitold_q73_sequencial_seq");
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = pg_query("insert into db_acountkey values($acount,11994,'$this->q73_sequencial','I')");
       $resac = pg_query("insert into db_acount values($acount,2075,11994,'','".AddSlashes(pg_result($resaco,0,'q73_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,2075,11995,'','".AddSlashes(pg_result($resaco,0,'q73_issplanitorigem'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,2075,11996,'','".AddSlashes(pg_result($resaco,0,'q73_issplanitdestino'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,2075,11997,'','".AddSlashes(pg_result($resaco,0,'q73_data'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,2075,11998,'','".AddSlashes(pg_result($resaco,0,'q73_hora'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,2075,11999,'','".AddSlashes(pg_result($resaco,0,'q73_ip'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($q73_sequencial=null) { 
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         $resac = pg_query("select nextval('db_acount_id_acount_seq') as acount");
         $acount = pg_result($resac,0,0);
         $resac = pg_query("insert into db_acountkey values($acount,11994,'$this->q73_sequencial','A')");
         if(isset($GLOBALS["HTTP_POST_VARS"]["q73_sequencial"]))
           $resac = pg_query("insert into db_acount values($acount,2075,11994,'".AddSlashes(pg_result($resaco,$conresaco,'q73_sequencial'))."','$this->q73_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["q73_issplanitorigem"]))
           $resac = pg_query("insert into db_acount values($acount,2075,11995,'".AddSlashes(pg_result($resaco,$conresaco,'q73_issplanitorigem'))."','$this->q73_issplanitorigem',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["q73_issplanitdestino"]))
           $resac = pg_query("insert into db_acount values($acount,2075,11996,'".AddSlashes(pg_result($resaco,$conresaco,'q73_issplanitdestino'))."','$this->q73_issplanitdestino',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["q73_data"]))
           $resac = pg_query("insert into db_acount values($acount,2075,11997,'".AddSlashes(pg_result($resaco,$conresaco,'q73_data'))."','$this->q73_data',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["q73_hora"]))
           $resac = pg_query("insert into db_acount values($acount,2075,11998,'".AddSlashes(pg_result($resaco,$conresaco,'q73_hora'))."','$this->q73_hora',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["q73_ip"]))
           $resac = pg_query("insert into db_acount values($acount,2075,11999,'".AddSlashes(pg_result($resaco,$conresaco,'q73_ip'))."','$this->q73_ip',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = @pg_exec($sql);
     if($result==false){ 
   ...
   function excluir ($q73_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         $resac = pg_query("select nextval('db_acount_id_acount_seq') as acount");
         $acount = pg_result($resac,0,0);
         $resac = pg_query("insert into db_acountkey values($acount,11994,'$q73_sequencial','E')");
         $resac = pg_query("insert into db_acount values($acount,2075,11994,'','".AddSlashes(pg_result($resaco,$iresaco,'q73_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,2075,11995,'','".AddSlashes(pg_result($resaco,$iresaco,'q73_issplanitorigem'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,2075,11996,'','".AddSlashes(pg_result($resaco,$iresaco,'q73_issplanitdestino'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,2075,11997,'','".AddSlashes(pg_result($resaco,$iresaco,'q73_data'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,2075,11998,'','".AddSlashes(pg_result($resaco,$iresaco,'q73_hora'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,2075,11999,'','".AddSlashes(pg_result($resaco,$iresaco,'q73_ip'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
