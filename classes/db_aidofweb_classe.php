...
class cl_aidofweb { 
   ...
   function incluir ($y07_sequencial){ 
     ...
     if($y07_sequencial == "" || $y07_sequencial == null ){
       $result = @pg_query("select nextval('aidofweb_y07_sequencial_seq')"); 
       if($result==false){
       ...
       $result = @pg_query("select last_value from aidofweb_y07_sequencial_seq");
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = pg_query("insert into db_acountkey values($acount,8197,'$this->y07_sequencial','I')");
       $resac = pg_query("insert into db_acount values($acount,1380,8197,'','".AddSlashes(pg_result($resaco,0,'y07_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,1380,8198,'','".AddSlashes(pg_result($resaco,0,'y07_aidof'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,1380,8199,'','".AddSlashes(pg_result($resaco,0,'y07_ip'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,1380,8200,'','".AddSlashes(pg_result($resaco,0,'y07_data'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,1380,8201,'','".AddSlashes(pg_result($resaco,0,'y07_hora'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($y07_sequencial=null) { 
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         $resac = pg_query("select nextval('db_acount_id_acount_seq') as acount");
         $acount = pg_result($resac,0,0);
         $resac = pg_query("insert into db_acountkey values($acount,8197,'$this->y07_sequencial','A')");
         if(isset($GLOBALS["HTTP_POST_VARS"]["y07_sequencial"]))
           $resac = pg_query("insert into db_acount values($acount,1380,8197,'".AddSlashes(pg_result($resaco,$conresaco,'y07_sequencial'))."','$this->y07_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["y07_aidof"]))
           $resac = pg_query("insert into db_acount values($acount,1380,8198,'".AddSlashes(pg_result($resaco,$conresaco,'y07_aidof'))."','$this->y07_aidof',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["y07_ip"]))
           $resac = pg_query("insert into db_acount values($acount,1380,8199,'".AddSlashes(pg_result($resaco,$conresaco,'y07_ip'))."','$this->y07_ip',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["y07_data"]))
           $resac = pg_query("insert into db_acount values($acount,1380,8200,'".AddSlashes(pg_result($resaco,$conresaco,'y07_data'))."','$this->y07_data',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["y07_hora"]))
           $resac = pg_query("insert into db_acount values($acount,1380,8201,'".AddSlashes(pg_result($resaco,$conresaco,'y07_hora'))."','$this->y07_hora',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = @pg_exec($sql);
     if($result==false){ 
   ...
   function excluir ($y07_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         $resac = pg_query("select nextval('db_acount_id_acount_seq') as acount");
         $acount = pg_result($resac,0,0);
         $resac = pg_query("insert into db_acountkey values($acount,8197,'$y07_sequencial','E')");
         $resac = pg_query("insert into db_acount values($acount,1380,8197,'','".AddSlashes(pg_result($resaco,$iresaco,'y07_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,1380,8198,'','".AddSlashes(pg_result($resaco,$iresaco,'y07_aidof'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,1380,8199,'','".AddSlashes(pg_result($resaco,$iresaco,'y07_ip'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,1380,8200,'','".AddSlashes(pg_result($resaco,$iresaco,'y07_data'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,1380,8201,'','".AddSlashes(pg_result($resaco,$iresaco,'y07_hora'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
