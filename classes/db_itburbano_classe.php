...
class cl_itburbano { 
   ...
   var $campos = "
                 ...
                 it05_itbisituacao = int8 = Situação na ITBI 
                 ";
   ...
   function incluir ($it05_guia){ 
     ...
     if($this->it05_itbisituacao == null ){ 
       $this->erro_sql = " Campo Situação na ITBI nao Informado.";
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = pg_query("insert into db_acountkey values($acount,5401,'$this->it05_guia','I')");
       $resac = pg_query("insert into db_acount values($acount,796,5401,'','".AddSlashes(pg_result($resaco,0,'it05_guia'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,796,5403,'','".AddSlashes(pg_result($resaco,0,'it05_frente'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,796,5405,'','".AddSlashes(pg_result($resaco,0,'it05_fundos'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,796,5404,'','".AddSlashes(pg_result($resaco,0,'it05_direito'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,796,5406,'','".AddSlashes(pg_result($resaco,0,'it05_esquerdo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,796,5414,'','".AddSlashes(pg_result($resaco,0,'it05_itbisituacao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($it05_guia=null) { 
     ...
     $sql .= " where  it05_guia = $this->it05_guia
";
     $resaco = $this->sql_record($this->sql_query_file($this->it05_guia));
     if($this->numrows>0){       $resac = pg_query("select nextval('db_acount_id_acount_seq') as acount");
       $acount = pg_result($resac,0,0);
       $resac = pg_query("insert into db_acountkey values($acount,5401,'$this->it05_guia','A')");
       if(isset($GLOBALS["HTTP_POST_VARS"]["it05_guia"]))
         $resac = pg_query("insert into db_acount values($acount,796,5401,'".AddSlashes(pg_result($resaco,0,'it05_guia'))."','$this->it05_guia',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       if(isset($GLOBALS["HTTP_POST_VARS"]["it05_frente"]))
         $resac = pg_query("insert into db_acount values($acount,796,5403,'".AddSlashes(pg_result($resaco,0,'it05_frente'))."','$this->it05_frente',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       if(isset($GLOBALS["HTTP_POST_VARS"]["it05_fundos"]))
         $resac = pg_query("insert into db_acount values($acount,796,5405,'".AddSlashes(pg_result($resaco,0,'it05_fundos'))."','$this->it05_fundos',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       if(isset($GLOBALS["HTTP_POST_VARS"]["it05_direito"]))
         $resac = pg_query("insert into db_acount values($acount,796,5404,'".AddSlashes(pg_result($resaco,0,'it05_direito'))."','$this->it05_direito',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       if(isset($GLOBALS["HTTP_POST_VARS"]["it05_esquerdo"]))
         $resac = pg_query("insert into db_acount values($acount,796,5406,'".AddSlashes(pg_result($resaco,0,'it05_esquerdo'))."','$this->it05_esquerdo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       if(isset($GLOBALS["HTTP_POST_VARS"]["it05_itbisituacao"]))
         $resac = pg_query("insert into db_acount values($acount,796,5414,'".AddSlashes(pg_result($resaco,0,'it05_itbisituacao'))."','$this->it05_itbisituacao',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     $result = @pg_exec($sql);
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
   ...
   function excluir ($it05_guia=null) { 
     $resaco = $this->sql_record($this->sql_query_file($it05_guia));
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         $resac = pg_query("select nextval('db_acount_id_acount_seq') as acount");
         $acount = pg_result($resac,0,0);
         $resac = pg_query("insert into db_acountkey values($acount,5401,'".pg_result($resaco,$iresaco,'it05_guia')."','E')");
         $resac = pg_query("insert into db_acount values($acount,796,5401,'','".AddSlashes(pg_result($resaco,$iresaco,'it05_guia'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,796,5403,'','".AddSlashes(pg_result($resaco,$iresaco,'it05_frente'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,796,5405,'','".AddSlashes(pg_result($resaco,$iresaco,'it05_fundos'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,796,5404,'','".AddSlashes(pg_result($resaco,$iresaco,'it05_direito'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,796,5406,'','".AddSlashes(pg_result($resaco,$iresaco,'it05_esquerdo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,796,5414,'','".AddSlashes(pg_result($resaco,$iresaco,'it05_itbisituacao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
