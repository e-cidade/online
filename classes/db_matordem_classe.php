...
//		      echo "<BR><BR>$sql;";		      
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = pg_query("insert into db_acount values($acount,1007,6252,'','".AddSlashes(pg_result($resaco,0,'m51_obs'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,1007,6257,'','".AddSlashes(pg_result($resaco,0,'m51_valortotal'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,1007,6601,'','".AddSlashes(pg_result($resaco,0,'m51_prazoent'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($m51_codordem=null) { 
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["m51_obs"]))
           $resac = pg_query("insert into db_acount values($acount,1007,6252,'".AddSlashes(pg_result($resaco,$conresaco,'m51_obs'))."','$this->m51_obs',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["m51_valortotal"]))
           $resac = pg_query("insert into db_acount values($acount,1007,6257,'".AddSlashes(pg_result($resaco,$conresaco,'m51_valortotal'))."','$this->m51_valortotal',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["m51_prazoent"]))
           $resac = pg_query("insert into db_acount values($acount,1007,6601,'".AddSlashes(pg_result($resaco,$conresaco,'m51_prazoent'))."','$this->m51_prazoent',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = @pg_exec($sql);
     if($result==false){ 
   ...
   function excluir ($m51_codordem=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         $resac = pg_query("select nextval('db_acount_id_acount_seq') as acount");
         $acount = pg_result($resac,0,0);
         $resac = pg_query("insert into db_acountkey values($acount,6216,'$m51_codordem','E')");
         ...
         $resac = pg_query("insert into db_acount values($acount,1007,6252,'','".AddSlashes(pg_result($resaco,$iresaco,'m51_obs'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,1007,6257,'','".AddSlashes(pg_result($resaco,$iresaco,'m51_valortotal'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,1007,6601,'','".AddSlashes(pg_result($resaco,$iresaco,'m51_prazoent'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
   ...
   function sql_query_anu( $m51_codordem=null,$campos="*",$ordem=null,$dbwhere=""){
     ...
     $sql .= "      inner join matordemitem on matordemitem.m52_codordem = matordem.m51_codordem";
     $sql .= "      inner join empempenho on empempenho.e60_numemp = matordemitem.m52_numemp";
     $sql .= "      inner join db_config   on db_config.codigo = e60_instit";
     $sql .= "      left join matordemanu  on  matordemanu.m53_codordem = matordem.m51_codordem";
     $sql2 = "";
     if($dbwhere==""){
       if($m51_codordem!=null ){
