...
class cl_modcarne { 
   ...
   function incluir ($k05_sequencial){ 
     ...
     if($k05_sequencial == "" || $k05_sequencial == null ){
       $result = @pg_query("select nextval('modcarne_k05_sequencial_seq')"); 
       if($result==false){
       ...
       $result = @pg_query("select last_value from modcarne_k05_sequencial_seq");
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = pg_query("insert into db_acountkey values($acount,8614,'$this->k05_sequencial','I')");
       $resac = pg_query("insert into db_acount values($acount,1465,8614,'','".AddSlashes(pg_result($resaco,0,'k05_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,1465,8612,'','".AddSlashes(pg_result($resaco,0,'k05_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,1465,8611,'','".AddSlashes(pg_result($resaco,0,'k05_tipo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,1465,8613,'','".AddSlashes(pg_result($resaco,0,'k05_modcarne'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($k05_sequencial=null) { 
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         $resac = pg_query("select nextval('db_acount_id_acount_seq') as acount");
         $acount = pg_result($resac,0,0);
         $resac = pg_query("insert into db_acountkey values($acount,8614,'$this->k05_sequencial','A')");
         if(isset($GLOBALS["HTTP_POST_VARS"]["k05_sequencial"]))
           $resac = pg_query("insert into db_acount values($acount,1465,8614,'".AddSlashes(pg_result($resaco,$conresaco,'k05_sequencial'))."','$this->k05_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["k05_codigo"]))
           $resac = pg_query("insert into db_acount values($acount,1465,8612,'".AddSlashes(pg_result($resaco,$conresaco,'k05_codigo'))."','$this->k05_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["k05_tipo"]))
           $resac = pg_query("insert into db_acount values($acount,1465,8611,'".AddSlashes(pg_result($resaco,$conresaco,'k05_tipo'))."','$this->k05_tipo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["k05_modcarne"]))
           $resac = pg_query("insert into db_acount values($acount,1465,8613,'".AddSlashes(pg_result($resaco,$conresaco,'k05_modcarne'))."','$this->k05_modcarne',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = @pg_exec($sql);
     if($result==false){ 
   ...
   function excluir ($k05_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         $resac = pg_query("select nextval('db_acount_id_acount_seq') as acount");
         $acount = pg_result($resac,0,0);
         $resac = pg_query("insert into db_acountkey values($acount,8614,'$k05_sequencial','E')");
         $resac = pg_query("insert into db_acount values($acount,1465,8614,'','".AddSlashes(pg_result($resaco,$iresaco,'k05_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,1465,8612,'','".AddSlashes(pg_result($resaco,$iresaco,'k05_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,1465,8611,'','".AddSlashes(pg_result($resaco,$iresaco,'k05_tipo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,1465,8613,'','".AddSlashes(pg_result($resaco,$iresaco,'k05_modcarne'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
