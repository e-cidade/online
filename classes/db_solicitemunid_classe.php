...
//     die($sql);
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = pg_query("insert into db_acountkey values($acount,6460,'$this->pc17_codigo','I')");
       $resac = pg_query("insert into db_acount values($acount,1061,6453,'','".AddSlashes(pg_result($resaco,0,'pc17_unid'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,1061,6459,'','".AddSlashes(pg_result($resaco,0,'pc17_quant'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,1061,6460,'','".AddSlashes(pg_result($resaco,0,'pc17_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($pc17_codigo=null) { 
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         $resac = pg_query("select nextval('db_acount_id_acount_seq') as acount");
         $acount = pg_result($resac,0,0);
         $resac = pg_query("insert into db_acountkey values($acount,6460,'$this->pc17_codigo','A')");
         if(isset($GLOBALS["HTTP_POST_VARS"]["pc17_unid"]))
           $resac = pg_query("insert into db_acount values($acount,1061,6453,'".AddSlashes(pg_result($resaco,$conresaco,'pc17_unid'))."','$this->pc17_unid',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["pc17_quant"]))
           $resac = pg_query("insert into db_acount values($acount,1061,6459,'".AddSlashes(pg_result($resaco,$conresaco,'pc17_quant'))."','$this->pc17_quant',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["pc17_codigo"]))
           $resac = pg_query("insert into db_acount values($acount,1061,6460,'".AddSlashes(pg_result($resaco,$conresaco,'pc17_codigo'))."','$this->pc17_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = @pg_exec($sql);
     if($result==false){ 
   ...
   function excluir ($pc17_codigo=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         $resac = pg_query("select nextval('db_acount_id_acount_seq') as acount");
         $acount = pg_result($resac,0,0);
         $resac = pg_query("insert into db_acountkey values($acount,6460,'".pg_result($resaco,$iresaco,'pc17_codigo')."','E')");
         $resac = pg_query("insert into db_acount values($acount,1061,6453,'','".AddSlashes(pg_result($resaco,$iresaco,'pc17_unid'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,1061,6459,'','".AddSlashes(pg_result($resaco,$iresaco,'pc17_quant'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,1061,6460,'','".AddSlashes(pg_result($resaco,$iresaco,'pc17_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
