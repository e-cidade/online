...
class cl_issplanitop { 
   ...
   function incluir ($q96_sequencial){ 
     ...
     if($q96_sequencial == "" || $q96_sequencial == null ){
       $result = @pg_query("select nextval('issplanitop_q96_sequencial_seq')"); 
       if($result==false){
       ...
       $result = @pg_query("select last_value from issplanitop_q96_sequencial_seq");
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = pg_query("insert into db_acountkey values($acount,10970,'$this->q96_sequencial','I')");
       $resac = pg_query("insert into db_acount values($acount,1892,10970,'','".AddSlashes(pg_result($resaco,0,'q96_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,1892,10971,'','".AddSlashes(pg_result($resaco,0,'q96_issplanit'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,1892,10972,'','".AddSlashes(pg_result($resaco,0,'q96_pagordem'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($q96_sequencial=null) { 
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         $resac = pg_query("select nextval('db_acount_id_acount_seq') as acount");
         $acount = pg_result($resac,0,0);
         $resac = pg_query("insert into db_acountkey values($acount,10970,'$this->q96_sequencial','A')");
         if(isset($GLOBALS["HTTP_POST_VARS"]["q96_sequencial"]))
           $resac = pg_query("insert into db_acount values($acount,1892,10970,'".AddSlashes(pg_result($resaco,$conresaco,'q96_sequencial'))."','$this->q96_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["q96_issplanit"]))
           $resac = pg_query("insert into db_acount values($acount,1892,10971,'".AddSlashes(pg_result($resaco,$conresaco,'q96_issplanit'))."','$this->q96_issplanit',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["q96_pagordem"]))
           $resac = pg_query("insert into db_acount values($acount,1892,10972,'".AddSlashes(pg_result($resaco,$conresaco,'q96_pagordem'))."','$this->q96_pagordem',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = @pg_exec($sql);
     if($result==false){ 
   ...
   function excluir ($q96_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         $resac = pg_query("select nextval('db_acount_id_acount_seq') as acount");
         $acount = pg_result($resac,0,0);
         $resac = pg_query("insert into db_acountkey values($acount,10970,'$q96_sequencial','E')");
         $resac = pg_query("insert into db_acount values($acount,1892,10970,'','".AddSlashes(pg_result($resaco,$iresaco,'q96_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,1892,10971,'','".AddSlashes(pg_result($resaco,$iresaco,'q96_issplanit'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,1892,10972,'','".AddSlashes(pg_result($resaco,$iresaco,'q96_pagordem'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
