...
class cl_issplanitinscr { 
   ...
   function incluir ($q31_sequencial){ 
     ...
     if($q31_sequencial == "" || $q31_sequencial == null ){
       $result = @pg_query("select nextval('issplanitinscr_q31_sequencial_seq')"); 
       if($result==false){
       ...
       $result = @pg_query("select last_value from issplanitinscr_q31_sequencial_seq");
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = pg_query("insert into db_acountkey values($acount,9196,'$this->q31_sequencial','I')");
       $resac = pg_query("insert into db_acount values($acount,1573,9196,'','".AddSlashes(pg_result($resaco,0,'q31_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,1573,9197,'','".AddSlashes(pg_result($resaco,0,'q31_issplanit'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,1573,9198,'','".AddSlashes(pg_result($resaco,0,'q31_inscr'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($q31_sequencial=null) { 
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         $resac = pg_query("select nextval('db_acount_id_acount_seq') as acount");
         $acount = pg_result($resac,0,0);
         $resac = pg_query("insert into db_acountkey values($acount,9196,'$this->q31_sequencial','A')");
         if(isset($GLOBALS["HTTP_POST_VARS"]["q31_sequencial"]))
           $resac = pg_query("insert into db_acount values($acount,1573,9196,'".AddSlashes(pg_result($resaco,$conresaco,'q31_sequencial'))."','$this->q31_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["q31_issplanit"]))
           $resac = pg_query("insert into db_acount values($acount,1573,9197,'".AddSlashes(pg_result($resaco,$conresaco,'q31_issplanit'))."','$this->q31_issplanit',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["q31_inscr"]))
           $resac = pg_query("insert into db_acount values($acount,1573,9198,'".AddSlashes(pg_result($resaco,$conresaco,'q31_inscr'))."','$this->q31_inscr',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = @pg_exec($sql);
     if($result==false){ 
   ...
   function excluir ($q31_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         $resac = pg_query("select nextval('db_acount_id_acount_seq') as acount");
         $acount = pg_result($resac,0,0);
         $resac = pg_query("insert into db_acountkey values($acount,9196,'$q31_sequencial','E')");
         $resac = pg_query("insert into db_acount values($acount,1573,9196,'','".AddSlashes(pg_result($resaco,$iresaco,'q31_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,1573,9197,'','".AddSlashes(pg_result($resaco,$iresaco,'q31_issplanit'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,1573,9198,'','".AddSlashes(pg_result($resaco,$iresaco,'q31_inscr'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
