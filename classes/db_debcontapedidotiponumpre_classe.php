...
class cl_debcontapedidotiponumpre { 
   ...
   function incluir ($d67_sequencial){ 
     ...
     if($d67_sequencial == "" || $d67_sequencial == null ){
       $result = @pg_query("select nextval('debcontapedidotiponumpre_d67_sequencial_seq')"); 
       if($result==false){
       ...
       $result = @pg_query("select last_value from debcontapedidotiponumpre_d67_sequencial_seq");
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = pg_query("insert into db_acountkey values($acount,7959,'$this->d67_sequencial','I')");
       $resac = pg_query("insert into db_acount values($acount,1334,7959,'','".AddSlashes(pg_result($resaco,0,'d67_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,1334,7960,'','".AddSlashes(pg_result($resaco,0,'d67_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,1334,7961,'','".AddSlashes(pg_result($resaco,0,'d67_numpre'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,1334,7962,'','".AddSlashes(pg_result($resaco,0,'d67_numpar'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($d67_sequencial=null) { 
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         $resac = pg_query("select nextval('db_acount_id_acount_seq') as acount");
         $acount = pg_result($resac,0,0);
         $resac = pg_query("insert into db_acountkey values($acount,7959,'$this->d67_sequencial','A')");
         if(isset($GLOBALS["HTTP_POST_VARS"]["d67_sequencial"]))
           $resac = pg_query("insert into db_acount values($acount,1334,7959,'".AddSlashes(pg_result($resaco,$conresaco,'d67_sequencial'))."','$this->d67_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["d67_codigo"]))
           $resac = pg_query("insert into db_acount values($acount,1334,7960,'".AddSlashes(pg_result($resaco,$conresaco,'d67_codigo'))."','$this->d67_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["d67_numpre"]))
           $resac = pg_query("insert into db_acount values($acount,1334,7961,'".AddSlashes(pg_result($resaco,$conresaco,'d67_numpre'))."','$this->d67_numpre',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["d67_numpar"]))
           $resac = pg_query("insert into db_acount values($acount,1334,7962,'".AddSlashes(pg_result($resaco,$conresaco,'d67_numpar'))."','$this->d67_numpar',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = @pg_exec($sql);
     if($result==false){ 
   ...
   function excluir ($d67_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         $resac = pg_query("select nextval('db_acount_id_acount_seq') as acount");
         $acount = pg_result($resac,0,0);
         $resac = pg_query("insert into db_acountkey values($acount,7959,'$d67_sequencial','E')");
         $resac = pg_query("insert into db_acount values($acount,1334,7959,'','".AddSlashes(pg_result($resaco,$iresaco,'d67_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,1334,7960,'','".AddSlashes(pg_result($resaco,$iresaco,'d67_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,1334,7961,'','".AddSlashes(pg_result($resaco,$iresaco,'d67_numpre'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,1334,7962,'','".AddSlashes(pg_result($resaco,$iresaco,'d67_numpar'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
