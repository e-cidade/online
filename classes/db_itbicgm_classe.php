...
class cl_itbicgm { 
   ...
   function incluir ($it02_guia,$it02_numcgm){ 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = pg_query("insert into db_acountkey values($acount,5399,'$this->it02_guia','I')");
       $resac = pg_query("insert into db_acountkey values($acount,5377,'$this->it02_numcgm','I')");
       $resac = pg_query("insert into db_acount values($acount,793,5399,'','".AddSlashes(pg_result($resaco,0,'it02_guia'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,793,5377,'','".AddSlashes(pg_result($resaco,0,'it02_numcgm'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($it02_guia=null,$it02_numcgm=null) { 
     ...
     $sql .= " where  it02_guia = $this->it02_guia
 and  it02_numcgm = $this->it02_numcgm
";
     $resaco = $this->sql_record($this->sql_query_file($this->it02_guia,$this->it02_numcgm));
     if($this->numrows>0){       $resac = pg_query("select nextval('db_acount_id_acount_seq') as acount");
       $acount = pg_result($resac,0,0);
       $resac = pg_query("insert into db_acountkey values($acount,5399,'$this->it02_guia','A')");
       $resac = pg_query("insert into db_acountkey values($acount,5377,'$this->it02_numcgm','A')");
       if(isset($GLOBALS["HTTP_POST_VARS"]["it02_guia"]))
         $resac = pg_query("insert into db_acount values($acount,793,5399,'".AddSlashes(pg_result($resaco,0,'it02_guia'))."','$this->it02_guia',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       if(isset($GLOBALS["HTTP_POST_VARS"]["it02_numcgm"]))
         $resac = pg_query("insert into db_acount values($acount,793,5377,'".AddSlashes(pg_result($resaco,0,'it02_numcgm'))."','$this->it02_numcgm',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     $result = @pg_exec($sql);
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
   ...
   function excluir ($it02_guia=null,$it02_numcgm=null) { 
     $resaco = $this->sql_record($this->sql_query_file($it02_guia,$it02_numcgm));
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         $resac = pg_query("select nextval('db_acount_id_acount_seq') as acount");
         $acount = pg_result($resac,0,0);
         $resac = pg_query("insert into db_acountkey values($acount,5399,'".pg_result($resaco,$iresaco,'it02_guia')."','E')");
         $resac = pg_query("insert into db_acountkey values($acount,5377,'".pg_result($resaco,$iresaco,'it02_numcgm')."','E')");
         $resac = pg_query("insert into db_acount values($acount,793,5399,'','".AddSlashes(pg_result($resaco,$iresaco,'it02_guia'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,793,5377,'','".AddSlashes(pg_result($resaco,$iresaco,'it02_numcgm'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
