...
class cl_issplannumpre { 
   ...
   function incluir ($q32_sequencial){ 
     ...
     if($q32_sequencial == "" || $q32_sequencial == null ){
       $result = @pg_query("select nextval('issplannumpre_q32_sequencial_seq')"); 
       if($result==false){
       ...
       $result = @pg_query("select last_value from issplannumpre_q32_sequencial_seq");
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = pg_query("insert into db_acountkey values($acount,9199,'$this->q32_sequencial','I')");
       $resac = pg_query("insert into db_acount values($acount,1574,9199,'','".AddSlashes(pg_result($resaco,0,'q32_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,1574,9200,'','".AddSlashes(pg_result($resaco,0,'q32_planilha'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,1574,9201,'','".AddSlashes(pg_result($resaco,0,'q32_numpre'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,1574,9212,'','".AddSlashes(pg_result($resaco,0,'q32_dataop'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,1574,9213,'','".AddSlashes(pg_result($resaco,0,'q32_horaop'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,1574,12001,'','".AddSlashes(pg_result($resaco,0,'q32_status'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($q32_sequencial=null) { 
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         $resac = pg_query("select nextval('db_acount_id_acount_seq') as acount");
         $acount = pg_result($resac,0,0);
         $resac = pg_query("insert into db_acountkey values($acount,9199,'$this->q32_sequencial','A')");
         if(isset($GLOBALS["HTTP_POST_VARS"]["q32_sequencial"]))
           $resac = pg_query("insert into db_acount values($acount,1574,9199,'".AddSlashes(pg_result($resaco,$conresaco,'q32_sequencial'))."','$this->q32_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["q32_planilha"]))
           $resac = pg_query("insert into db_acount values($acount,1574,9200,'".AddSlashes(pg_result($resaco,$conresaco,'q32_planilha'))."','$this->q32_planilha',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["q32_numpre"]))
           $resac = pg_query("insert into db_acount values($acount,1574,9201,'".AddSlashes(pg_result($resaco,$conresaco,'q32_numpre'))."','$this->q32_numpre',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["q32_dataop"]))
           $resac = pg_query("insert into db_acount values($acount,1574,9212,'".AddSlashes(pg_result($resaco,$conresaco,'q32_dataop'))."','$this->q32_dataop',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["q32_horaop"]))
           $resac = pg_query("insert into db_acount values($acount,1574,9213,'".AddSlashes(pg_result($resaco,$conresaco,'q32_horaop'))."','$this->q32_horaop',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["q32_status"]))
           $resac = pg_query("insert into db_acount values($acount,1574,12001,'".AddSlashes(pg_result($resaco,$conresaco,'q32_status'))."','$this->q32_status',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
		 //die($sql);
   ...
   function excluir ($q32_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         $resac = pg_query("select nextval('db_acount_id_acount_seq') as acount");
         $acount = pg_result($resac,0,0);
         $resac = pg_query("insert into db_acountkey values($acount,9199,'$q32_sequencial','E')");
         $resac = pg_query("insert into db_acount values($acount,1574,9199,'','".AddSlashes(pg_result($resaco,$iresaco,'q32_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,1574,9200,'','".AddSlashes(pg_result($resaco,$iresaco,'q32_planilha'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,1574,9201,'','".AddSlashes(pg_result($resaco,$iresaco,'q32_numpre'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,1574,9212,'','".AddSlashes(pg_result($resaco,$iresaco,'q32_dataop'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,1574,9213,'','".AddSlashes(pg_result($resaco,$iresaco,'q32_horaop'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,1574,12001,'','".AddSlashes(pg_result($resaco,$iresaco,'q32_status'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
