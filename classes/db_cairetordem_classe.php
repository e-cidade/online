...
class cl_cairetordem { 
   ...
   function incluir ($k32_sequencia){ 
     ...
     if($k32_sequencia == "" || $k32_sequencia == null ){
       $result = @pg_query("select nextval('cairetordem_k32_sequencia_seq')"); 
       if($result==false){
       ...
       $result = @pg_query("select last_value from cairetordem_k32_sequencia_seq");
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = pg_query("insert into db_acountkey values($acount,8865,'$this->k32_sequencia','I')");
       $resac = pg_query("insert into db_acount values($acount,1511,8865,'','".AddSlashes(pg_result($resaco,0,'k32_sequencia'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,1511,8866,'','".AddSlashes(pg_result($resaco,0,'k32_numpre'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,1511,8867,'','".AddSlashes(pg_result($resaco,0,'k32_ordpag'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($k32_sequencia=null) { 
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         $resac = pg_query("select nextval('db_acount_id_acount_seq') as acount");
         $acount = pg_result($resac,0,0);
         $resac = pg_query("insert into db_acountkey values($acount,8865,'$this->k32_sequencia','A')");
         if(isset($GLOBALS["HTTP_POST_VARS"]["k32_sequencia"]))
           $resac = pg_query("insert into db_acount values($acount,1511,8865,'".AddSlashes(pg_result($resaco,$conresaco,'k32_sequencia'))."','$this->k32_sequencia',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["k32_numpre"]))
           $resac = pg_query("insert into db_acount values($acount,1511,8866,'".AddSlashes(pg_result($resaco,$conresaco,'k32_numpre'))."','$this->k32_numpre',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["k32_ordpag"]))
           $resac = pg_query("insert into db_acount values($acount,1511,8867,'".AddSlashes(pg_result($resaco,$conresaco,'k32_ordpag'))."','$this->k32_ordpag',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = @pg_exec($sql);
     if($result==false){ 
   ...
   function excluir ($k32_sequencia=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         $resac = pg_query("select nextval('db_acount_id_acount_seq') as acount");
         $acount = pg_result($resac,0,0);
         $resac = pg_query("insert into db_acountkey values($acount,8865,'$k32_sequencia','E')");
         $resac = pg_query("insert into db_acount values($acount,1511,8865,'','".AddSlashes(pg_result($resaco,$iresaco,'k32_sequencia'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,1511,8866,'','".AddSlashes(pg_result($resaco,$iresaco,'k32_numpre'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,1511,8867,'','".AddSlashes(pg_result($resaco,$iresaco,'k32_ordpag'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
