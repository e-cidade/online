...
class cl_db_cgmatualizaliga { 
   ...
   function incluir ($w12_sequencial){ 
     ...
     if($w12_sequencial == "" || $w12_sequencial == null ){
       $result = @pg_query("select nextval('db_cgmatualizaliga_w12_sequencial_seq')"); 
       if($result==false){
       ...
       $result = @pg_query("select last_value from db_cgmatualizaliga_w12_sequencial_seq");
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = pg_query("insert into db_acountkey values($acount,8204,'$this->w12_sequencial','I')");
       $resac = pg_query("insert into db_acount values($acount,1382,8204,'','".AddSlashes(pg_result($resaco,0,'w12_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,1382,8205,'','".AddSlashes(pg_result($resaco,0,'w12_cgmatualiza'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,1382,8206,'','".AddSlashes(pg_result($resaco,0,'w12_numcgm'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($w12_sequencial=null) { 
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         $resac = pg_query("select nextval('db_acount_id_acount_seq') as acount");
         $acount = pg_result($resac,0,0);
         $resac = pg_query("insert into db_acountkey values($acount,8204,'$this->w12_sequencial','A')");
         if(isset($GLOBALS["HTTP_POST_VARS"]["w12_sequencial"]))
           $resac = pg_query("insert into db_acount values($acount,1382,8204,'".AddSlashes(pg_result($resaco,$conresaco,'w12_sequencial'))."','$this->w12_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["w12_cgmatualiza"]))
           $resac = pg_query("insert into db_acount values($acount,1382,8205,'".AddSlashes(pg_result($resaco,$conresaco,'w12_cgmatualiza'))."','$this->w12_cgmatualiza',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["w12_numcgm"]))
           $resac = pg_query("insert into db_acount values($acount,1382,8206,'".AddSlashes(pg_result($resaco,$conresaco,'w12_numcgm'))."','$this->w12_numcgm',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = @pg_exec($sql);
     if($result==false){ 
   ...
   function excluir ($w12_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         $resac = pg_query("select nextval('db_acount_id_acount_seq') as acount");
         $acount = pg_result($resac,0,0);
         $resac = pg_query("insert into db_acountkey values($acount,8204,'$w12_sequencial','E')");
         $resac = pg_query("insert into db_acount values($acount,1382,8204,'','".AddSlashes(pg_result($resaco,$iresaco,'w12_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,1382,8205,'','".AddSlashes(pg_result($resaco,$iresaco,'w12_cgmatualiza'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,1382,8206,'','".AddSlashes(pg_result($resaco,$iresaco,'w12_numcgm'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
   ...
   function sql_query ( $w12_sequencial=null,$campos="*",$ordem=null,$dbwhere=""){ 
     ...
     $sql .= "      inner join cgm  on  cgm.z01_numcgm = db_cgmatualiza.w11_numcgm";
     $sql2 = "";
     if($dbwhere==""){
       if($w12_sequencial!=null ){
