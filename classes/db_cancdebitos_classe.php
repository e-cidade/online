...
class cl_cancdebitos { 
   ...
   function incluir ($k20_codigo){ 
     ...
     if($k20_codigo == "" || $k20_codigo == null ){
       $result = @pg_query("select nextval('cancdebitos_k20_codigo_seq')"); 
       if($result==false){
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = pg_query("insert into db_acountkey values($acount,7326,'$this->k20_codigo','I')");
       $resac = pg_query("insert into db_acount values($acount,1217,7326,'','".AddSlashes(pg_result($resaco,0,'k20_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,1217,7763,'','".AddSlashes(pg_result($resaco,0,'k20_descr'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,1217,7328,'','".AddSlashes(pg_result($resaco,0,'k20_hora'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,1217,7327,'','".AddSlashes(pg_result($resaco,0,'k20_data'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,1217,7329,'','".AddSlashes(pg_result($resaco,0,'k20_usuario'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($k20_codigo=null) { 
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         $resac = pg_query("select nextval('db_acount_id_acount_seq') as acount");
         $acount = pg_result($resac,0,0);
         $resac = pg_query("insert into db_acountkey values($acount,7326,'$this->k20_codigo','A')");
         if(isset($GLOBALS["HTTP_POST_VARS"]["k20_codigo"]))
           $resac = pg_query("insert into db_acount values($acount,1217,7326,'".AddSlashes(pg_result($resaco,$conresaco,'k20_codigo'))."','$this->k20_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["k20_descr"]))
           $resac = pg_query("insert into db_acount values($acount,1217,7763,'".AddSlashes(pg_result($resaco,$conresaco,'k20_descr'))."','$this->k20_descr',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["k20_hora"]))
           $resac = pg_query("insert into db_acount values($acount,1217,7328,'".AddSlashes(pg_result($resaco,$conresaco,'k20_hora'))."','$this->k20_hora',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["k20_data"]))
           $resac = pg_query("insert into db_acount values($acount,1217,7327,'".AddSlashes(pg_result($resaco,$conresaco,'k20_data'))."','$this->k20_data',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["k20_usuario"]))
           $resac = pg_query("insert into db_acount values($acount,1217,7329,'".AddSlashes(pg_result($resaco,$conresaco,'k20_usuario'))."','$this->k20_usuario',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = @pg_exec($sql);
     if($result==false){ 
   ...
   function excluir ($k20_codigo=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         $resac = pg_query("select nextval('db_acount_id_acount_seq') as acount");
         $acount = pg_result($resac,0,0);
         $resac = pg_query("insert into db_acountkey values($acount,7326,'$k20_codigo','E')");
         $resac = pg_query("insert into db_acount values($acount,1217,7326,'','".AddSlashes(pg_result($resaco,$iresaco,'k20_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,1217,7763,'','".AddSlashes(pg_result($resaco,$iresaco,'k20_descr'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,1217,7328,'','".AddSlashes(pg_result($resaco,$iresaco,'k20_hora'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,1217,7327,'','".AddSlashes(pg_result($resaco,$iresaco,'k20_data'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,1217,7329,'','".AddSlashes(pg_result($resaco,$iresaco,'k20_usuario'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
...
//     die($sql.$sql2);
   ...
   return $sql;
    ...
    $codigo=$this->k20_codigo;
		...
		//echo "<br>incluiu cancdebitos =$codigo ";
      ...
      $erro=true;
        ...
        //echo "<br> cancdebitosreg = ".$clcancdebitosreg->	k21_sequencia;	
																			
				// inclui na cancdebitosprocreg
