...
class cl_cancdebitosprocreg { 
   ...
   function incluir ($k24_sequencia){ 
     ...
     if($k24_sequencia == "" || $k24_sequencia == null ){
       $result = @pg_query("select nextval('cancdebitosprocreg_k24_sequencia_seq')"); 
       if($result==false){
       ...
       $result = @pg_query("select last_value from cancdebitosprocreg_k24_sequencia_seq");
    ...
    //  echo"<br>$sql";
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = pg_query("insert into db_acountkey values($acount,7416,'$this->k24_sequencia','I')");
       $resac = pg_query("insert into db_acount values($acount,1234,7416,'','".AddSlashes(pg_result($resaco,0,'k24_sequencia'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,1234,7417,'','".AddSlashes(pg_result($resaco,0,'k24_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,1234,7418,'','".AddSlashes(pg_result($resaco,0,'k24_cancdebitosreg'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,1234,7419,'','".AddSlashes(pg_result($resaco,0,'k24_vlrhis'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,1234,7420,'','".AddSlashes(pg_result($resaco,0,'k24_vlrcor'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,1234,7421,'','".AddSlashes(pg_result($resaco,0,'k24_juros'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,1234,7422,'','".AddSlashes(pg_result($resaco,0,'k24_multa'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,1234,7423,'','".AddSlashes(pg_result($resaco,0,'k24_desconto'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($k24_sequencia=null) { 
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         $resac = pg_query("select nextval('db_acount_id_acount_seq') as acount");
         $acount = pg_result($resac,0,0);
         $resac = pg_query("insert into db_acountkey values($acount,7416,'$this->k24_sequencia','A')");
         if(isset($GLOBALS["HTTP_POST_VARS"]["k24_sequencia"]))
           $resac = pg_query("insert into db_acount values($acount,1234,7416,'".AddSlashes(pg_result($resaco,$conresaco,'k24_sequencia'))."','$this->k24_sequencia',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["k24_codigo"]))
           $resac = pg_query("insert into db_acount values($acount,1234,7417,'".AddSlashes(pg_result($resaco,$conresaco,'k24_codigo'))."','$this->k24_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["k24_cancdebitosreg"]))
           $resac = pg_query("insert into db_acount values($acount,1234,7418,'".AddSlashes(pg_result($resaco,$conresaco,'k24_cancdebitosreg'))."','$this->k24_cancdebitosreg',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["k24_vlrhis"]))
           $resac = pg_query("insert into db_acount values($acount,1234,7419,'".AddSlashes(pg_result($resaco,$conresaco,'k24_vlrhis'))."','$this->k24_vlrhis',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["k24_vlrcor"]))
           $resac = pg_query("insert into db_acount values($acount,1234,7420,'".AddSlashes(pg_result($resaco,$conresaco,'k24_vlrcor'))."','$this->k24_vlrcor',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["k24_juros"]))
           $resac = pg_query("insert into db_acount values($acount,1234,7421,'".AddSlashes(pg_result($resaco,$conresaco,'k24_juros'))."','$this->k24_juros',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["k24_multa"]))
           $resac = pg_query("insert into db_acount values($acount,1234,7422,'".AddSlashes(pg_result($resaco,$conresaco,'k24_multa'))."','$this->k24_multa',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["k24_desconto"]))
           $resac = pg_query("insert into db_acount values($acount,1234,7423,'".AddSlashes(pg_result($resaco,$conresaco,'k24_desconto'))."','$this->k24_desconto',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = @pg_exec($sql);
     if($result==false){ 
   ...
   function excluir ($k24_sequencia=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         $resac = pg_query("select nextval('db_acount_id_acount_seq') as acount");
         $acount = pg_result($resac,0,0);
         $resac = pg_query("insert into db_acountkey values($acount,7416,'$k24_sequencia','E')");
         $resac = pg_query("insert into db_acount values($acount,1234,7416,'','".AddSlashes(pg_result($resaco,$iresaco,'k24_sequencia'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,1234,7417,'','".AddSlashes(pg_result($resaco,$iresaco,'k24_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,1234,7418,'','".AddSlashes(pg_result($resaco,$iresaco,'k24_cancdebitosreg'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,1234,7419,'','".AddSlashes(pg_result($resaco,$iresaco,'k24_vlrhis'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,1234,7420,'','".AddSlashes(pg_result($resaco,$iresaco,'k24_vlrcor'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,1234,7421,'','".AddSlashes(pg_result($resaco,$iresaco,'k24_juros'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,1234,7422,'','".AddSlashes(pg_result($resaco,$iresaco,'k24_multa'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,1234,7423,'','".AddSlashes(pg_result($resaco,$iresaco,'k24_desconto'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
