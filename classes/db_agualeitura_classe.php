   ...
   function alterar ($x21_codleitura=null) { 
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["x21_codleitura"]))
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["x21_codhidrometro"]))
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["x21_exerc"]))
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["x21_mes"]))
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["x21_situacao"]))
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["x21_numcgm"]))
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["x21_dtleitura"]))
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["x21_usuario"]))
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["x21_dtinc"]))
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["x21_leitura"]))
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["x21_consumo"]))
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["x21_excesso"]))
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["x21_virou"]))
