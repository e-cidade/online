...
class cl_itbipropriold { 
   ...
   function incluir ($it20_guia,$it20_numcgm){ 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = pg_query("insert into db_acountkey values($acount,6104,'$this->it20_guia','I')");
       $resac = pg_query("insert into db_acountkey values($acount,6105,'$this->it20_numcgm','I')");
       $resac = pg_query("insert into db_acount values($acount,981,6104,'','".AddSlashes(pg_result($resaco,0,'it20_guia'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,981,6105,'','".AddSlashes(pg_result($resaco,0,'it20_numcgm'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,981,6106,'','".AddSlashes(pg_result($resaco,0,'it20_pri'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($it20_guia=null,$it20_numcgm=null) { 
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         $resac = pg_query("select nextval('db_acount_id_acount_seq') as acount");
         $acount = pg_result($resac,0,0);
         $resac = pg_query("insert into db_acountkey values($acount,6104,'$this->it20_guia','A')");
         $resac = pg_query("insert into db_acountkey values($acount,6105,'$this->it20_numcgm','A')");
         if(isset($GLOBALS["HTTP_POST_VARS"]["it20_guia"]))
           $resac = pg_query("insert into db_acount values($acount,981,6104,'".AddSlashes(pg_result($resaco,$conresaco,'it20_guia'))."','$this->it20_guia',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["it20_numcgm"]))
           $resac = pg_query("insert into db_acount values($acount,981,6105,'".AddSlashes(pg_result($resaco,$conresaco,'it20_numcgm'))."','$this->it20_numcgm',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["it20_pri"]))
           $resac = pg_query("insert into db_acount values($acount,981,6106,'".AddSlashes(pg_result($resaco,$conresaco,'it20_pri'))."','$this->it20_pri',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = @pg_exec($sql);
     if($result==false){ 
   ...
   function excluir ($it20_guia=null,$it20_numcgm=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         $resac = pg_query("select nextval('db_acount_id_acount_seq') as acount");
         $acount = pg_result($resac,0,0);
         $resac = pg_query("insert into db_acountkey values($acount,6104,'".pg_result($resaco,$iresaco,'it20_guia')."','E')");
         $resac = pg_query("insert into db_acountkey values($acount,6105,'".pg_result($resaco,$iresaco,'it20_numcgm')."','E')");
         $resac = pg_query("insert into db_acount values($acount,981,6104,'','".AddSlashes(pg_result($resaco,$iresaco,'it20_guia'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,981,6105,'','".AddSlashes(pg_result($resaco,$iresaco,'it20_numcgm'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,981,6106,'','".AddSlashes(pg_result($resaco,$iresaco,'it20_pri'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
