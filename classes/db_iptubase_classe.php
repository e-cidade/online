...
class cl_iptubase { 
   ...
   function incluir ($j01_matric){ 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = pg_query("insert into db_acount values($acount,27,141,'','".AddSlashes(pg_result($resaco,0,'j01_matric'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,27,142,'','".AddSlashes(pg_result($resaco,0,'j01_numcgm'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,27,143,'','".AddSlashes(pg_result($resaco,0,'j01_idbql'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,27,144,'','".AddSlashes(pg_result($resaco,0,'j01_baixa'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,27,145,'','".AddSlashes(pg_result($resaco,0,'j01_codave'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,27,368,'','".AddSlashes(pg_result($resaco,0,'j01_fracao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["j01_matric"]))
           $resac = pg_query("insert into db_acount values($acount,27,141,'".AddSlashes(pg_result($resaco,$conresaco,'j01_matric'))."','$this->j01_matric',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["j01_numcgm"]))
           $resac = pg_query("insert into db_acount values($acount,27,142,'".AddSlashes(pg_result($resaco,$conresaco,'j01_numcgm'))."','$this->j01_numcgm',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["j01_idbql"]))
           $resac = pg_query("insert into db_acount values($acount,27,143,'".AddSlashes(pg_result($resaco,$conresaco,'j01_idbql'))."','$this->j01_idbql',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["j01_baixa"]))
           $resac = pg_query("insert into db_acount values($acount,27,144,'".AddSlashes(pg_result($resaco,$conresaco,'j01_baixa'))."','$this->j01_baixa',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["j01_codave"]))
           $resac = pg_query("insert into db_acount values($acount,27,145,'".AddSlashes(pg_result($resaco,$conresaco,'j01_codave'))."','$this->j01_codave',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["j01_fracao"]))
           $resac = pg_query("insert into db_acount values($acount,27,368,'".AddSlashes(pg_result($resaco,$conresaco,'j01_fracao'))."','$this->j01_fracao',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = @pg_exec($sql);
     if($result==false){ 
   ...
   function excluir ($j01_matric=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         $resac = pg_query("select nextval('db_acount_id_acount_seq') as acount");
         $acount = pg_result($resac,0,0);
         $resac = pg_query("insert into db_acountkey values($acount,141,'$j01_matric','E')");
         $resac = pg_query("insert into db_acount values($acount,27,141,'','".AddSlashes(pg_result($resaco,$iresaco,'j01_matric'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,27,142,'','".AddSlashes(pg_result($resaco,$iresaco,'j01_numcgm'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,27,143,'','".AddSlashes(pg_result($resaco,$iresaco,'j01_idbql'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,27,144,'','".AddSlashes(pg_result($resaco,$iresaco,'j01_baixa'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,27,145,'','".AddSlashes(pg_result($resaco,$iresaco,'j01_codave'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,27,368,'','".AddSlashes(pg_result($resaco,$iresaco,'j01_fracao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
...
$sql = "
   select distinct * from (  select j01_matric, 'PROPRIETARIO'::varchar(12) as proprietario, j01_idbql, cgm.z01_nome, j01_baixa
                                     from iptubase
                                     inner join cgm on j01_numcgm = z01_numcgm
						 ...
						 select distinct * from (  
									select distinct 
												 ...
												 case when j41_matric is null then 'PROPRIETARIO'::varchar(12) 
												      else j41_matric::varchar ||'PROMITENTE'::varchar(12) end as proprietario, 
												 j01_idbql,
									...
									left join promitente on j41_matric = iptubase.j01_matric  
									left join cgm a on a.z01_numcgm = iptubase.j01_numcgm
									left join cgm b on b.z01_numcgm = j41_numcgm
									where case when j41_numcgm is not null then j41_numcgm = $pesquisaPorNome
									            else  j01_numcgm = $pesquisaPorNome end                  
						 ) as dados
