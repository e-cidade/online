...
class cl_debcontapedido { 
   ...
   function incluir ($d63_codigo){ 
     ...
     if($d63_codigo == "" || $d63_codigo == null ){
       $result = @pg_query("select nextval('debcontapedido_d63_codigo_seq')"); 
       if($result==false){
       ...
       $result = @pg_query("select last_value from debcontapedido_d63_codigo_seq");
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = pg_query("insert into db_acountkey values($acount,7941,'$this->d63_codigo','I')");
       $resac = pg_query("insert into db_acount values($acount,1330,7941,'','".AddSlashes(pg_result($resaco,0,'d63_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,1330,7944,'','".AddSlashes(pg_result($resaco,0,'d63_instit'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,1330,7945,'','".AddSlashes(pg_result($resaco,0,'d63_banco'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,1330,7946,'','".AddSlashes(pg_result($resaco,0,'d63_agencia'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,1330,7947,'','".AddSlashes(pg_result($resaco,0,'d63_conta'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,1330,7948,'','".AddSlashes(pg_result($resaco,0,'d63_datalanc'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,1330,7949,'','".AddSlashes(pg_result($resaco,0,'d63_horalanc'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,1330,7950,'','".AddSlashes(pg_result($resaco,0,'d63_status'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,1330,8829,'','".AddSlashes(pg_result($resaco,0,'d63_idempresa'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($d63_codigo=null) { 
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         $resac = pg_query("select nextval('db_acount_id_acount_seq') as acount");
         $acount = pg_result($resac,0,0);
         $resac = pg_query("insert into db_acountkey values($acount,7941,'$this->d63_codigo','A')");
         if(isset($GLOBALS["HTTP_POST_VARS"]["d63_codigo"]))
           $resac = pg_query("insert into db_acount values($acount,1330,7941,'".AddSlashes(pg_result($resaco,$conresaco,'d63_codigo'))."','$this->d63_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["d63_instit"]))
           $resac = pg_query("insert into db_acount values($acount,1330,7944,'".AddSlashes(pg_result($resaco,$conresaco,'d63_instit'))."','$this->d63_instit',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["d63_banco"]))
           $resac = pg_query("insert into db_acount values($acount,1330,7945,'".AddSlashes(pg_result($resaco,$conresaco,'d63_banco'))."','$this->d63_banco',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["d63_agencia"]))
           $resac = pg_query("insert into db_acount values($acount,1330,7946,'".AddSlashes(pg_result($resaco,$conresaco,'d63_agencia'))."','$this->d63_agencia',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["d63_conta"]))
           $resac = pg_query("insert into db_acount values($acount,1330,7947,'".AddSlashes(pg_result($resaco,$conresaco,'d63_conta'))."','$this->d63_conta',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["d63_datalanc"]))
           $resac = pg_query("insert into db_acount values($acount,1330,7948,'".AddSlashes(pg_result($resaco,$conresaco,'d63_datalanc'))."','$this->d63_datalanc',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["d63_horalanc"]))
           $resac = pg_query("insert into db_acount values($acount,1330,7949,'".AddSlashes(pg_result($resaco,$conresaco,'d63_horalanc'))."','$this->d63_horalanc',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["d63_status"]))
           $resac = pg_query("insert into db_acount values($acount,1330,7950,'".AddSlashes(pg_result($resaco,$conresaco,'d63_status'))."','$this->d63_status',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["d63_idempresa"]))
           $resac = pg_query("insert into db_acount values($acount,1330,8829,'".AddSlashes(pg_result($resaco,$conresaco,'d63_idempresa'))."','$this->d63_idempresa',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = @pg_exec($sql);
     if($result==false){ 
   ...
   function excluir ($d63_codigo=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         $resac = pg_query("select nextval('db_acount_id_acount_seq') as acount");
         $acount = pg_result($resac,0,0);
         $resac = pg_query("insert into db_acountkey values($acount,7941,'$d63_codigo','E')");
         $resac = pg_query("insert into db_acount values($acount,1330,7941,'','".AddSlashes(pg_result($resaco,$iresaco,'d63_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,1330,7944,'','".AddSlashes(pg_result($resaco,$iresaco,'d63_instit'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,1330,7945,'','".AddSlashes(pg_result($resaco,$iresaco,'d63_banco'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,1330,7946,'','".AddSlashes(pg_result($resaco,$iresaco,'d63_agencia'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,1330,7947,'','".AddSlashes(pg_result($resaco,$iresaco,'d63_conta'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,1330,7948,'','".AddSlashes(pg_result($resaco,$iresaco,'d63_datalanc'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,1330,7949,'','".AddSlashes(pg_result($resaco,$iresaco,'d63_horalanc'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,1330,7950,'','".AddSlashes(pg_result($resaco,$iresaco,'d63_status'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,1330,8829,'','".AddSlashes(pg_result($resaco,$iresaco,'d63_idempresa'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
