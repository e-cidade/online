...
class cl_pcorcamval { 
   ...
   function incluir ($pc23_orcamforne,$pc23_orcamitem){ 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = pg_query("insert into db_acountkey values($acount,6378,'$this->pc23_orcamforne','I')");
       $resac = pg_query("insert into db_acountkey values($acount,5517,'$this->pc23_orcamitem','I')");
       $resac = pg_query("insert into db_acount values($acount,863,6378,'','".AddSlashes(pg_result($resaco,0,'pc23_orcamforne'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,863,5517,'','".AddSlashes(pg_result($resaco,0,'pc23_orcamitem'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,863,5518,'','".AddSlashes(pg_result($resaco,0,'pc23_valor'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,863,6456,'','".AddSlashes(pg_result($resaco,0,'pc23_quant'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,863,6831,'','".AddSlashes(pg_result($resaco,0,'pc23_obs'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,863,7645,'','".AddSlashes(pg_result($resaco,0,'pc23_vlrun'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,863,9205,'','".AddSlashes(pg_result($resaco,0,'pc23_validmin'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($pc23_orcamforne=null,$pc23_orcamitem=null) { 
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         $resac = pg_query("select nextval('db_acount_id_acount_seq') as acount");
         $acount = pg_result($resac,0,0);
         $resac = pg_query("insert into db_acountkey values($acount,6378,'$this->pc23_orcamforne','A')");
         $resac = pg_query("insert into db_acountkey values($acount,5517,'$this->pc23_orcamitem','A')");
         if(isset($GLOBALS["HTTP_POST_VARS"]["pc23_orcamforne"]))
           $resac = pg_query("insert into db_acount values($acount,863,6378,'".AddSlashes(pg_result($resaco,$conresaco,'pc23_orcamforne'))."','$this->pc23_orcamforne',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["pc23_orcamitem"]))
           $resac = pg_query("insert into db_acount values($acount,863,5517,'".AddSlashes(pg_result($resaco,$conresaco,'pc23_orcamitem'))."','$this->pc23_orcamitem',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["pc23_valor"]))
           $resac = pg_query("insert into db_acount values($acount,863,5518,'".AddSlashes(pg_result($resaco,$conresaco,'pc23_valor'))."','$this->pc23_valor',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["pc23_quant"]))
           $resac = pg_query("insert into db_acount values($acount,863,6456,'".AddSlashes(pg_result($resaco,$conresaco,'pc23_quant'))."','$this->pc23_quant',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["pc23_obs"]))
           $resac = pg_query("insert into db_acount values($acount,863,6831,'".AddSlashes(pg_result($resaco,$conresaco,'pc23_obs'))."','$this->pc23_obs',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["pc23_vlrun"]))
           $resac = pg_query("insert into db_acount values($acount,863,7645,'".AddSlashes(pg_result($resaco,$conresaco,'pc23_vlrun'))."','$this->pc23_vlrun',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["pc23_validmin"]))
           $resac = pg_query("insert into db_acount values($acount,863,9205,'".AddSlashes(pg_result($resaco,$conresaco,'pc23_validmin'))."','$this->pc23_validmin',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = @pg_exec($sql);
     if($result==false){ 
   ...
   function excluir ($pc23_orcamforne=null,$pc23_orcamitem=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         $resac = pg_query("select nextval('db_acount_id_acount_seq') as acount");
         $acount = pg_result($resac,0,0);
         $resac = pg_query("insert into db_acountkey values($acount,6378,'$pc23_orcamforne','E')");
         $resac = pg_query("insert into db_acountkey values($acount,5517,'$pc23_orcamitem','E')");
         $resac = pg_query("insert into db_acount values($acount,863,6378,'','".AddSlashes(pg_result($resaco,$iresaco,'pc23_orcamforne'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,863,5517,'','".AddSlashes(pg_result($resaco,$iresaco,'pc23_orcamitem'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,863,5518,'','".AddSlashes(pg_result($resaco,$iresaco,'pc23_valor'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,863,6456,'','".AddSlashes(pg_result($resaco,$iresaco,'pc23_quant'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,863,6831,'','".AddSlashes(pg_result($resaco,$iresaco,'pc23_obs'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,863,7645,'','".AddSlashes(pg_result($resaco,$iresaco,'pc23_vlrun'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,863,9205,'','".AddSlashes(pg_result($resaco,$iresaco,'pc23_validmin'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
