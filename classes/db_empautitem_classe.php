...
class cl_empautitem { 
   ...
   function alterar ($e55_autori=null,$e55_sequen=null) { 
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["e55_autori"]))
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["e55_item"]))
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["e55_sequen"]))
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["e55_quant"]))
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["e55_vltot"]))
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["e55_descr"]))
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["e55_codele"]))
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["e55_vlrun"]))
   ...
   function sql_query_lic ( $e55_autori=null,$e55_sequen=null,$campos="*",$ordem=null,$dbwhere=""){ 
     ...
     $sql .= "      inner join empautitempcprocitem on empautitempcprocitem.e73_sequen = empautitem.e55_sequen";
     $sql .= "                                     and empautitempcprocitem.e73_autori = empautitem.e55_autori";
     $sql .= "      inner join liclicitem           on liclicitem.l21_codpcprocitem    = empautitempcprocitem.e73_sequen";
