...
class cl_pcorcamitemsol { 
   ...
   function incluir ($pc29_orcamitem,$pc29_solicitem){ 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = pg_query("insert into db_acountkey values($acount,6389,'$this->pc29_orcamitem','I')");
       $resac = pg_query("insert into db_acountkey values($acount,5516,'$this->pc29_solicitem','I')");
       $resac = pg_query("insert into db_acount values($acount,1045,6389,'','".AddSlashes(pg_result($resaco,0,'pc29_orcamitem'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,1045,5516,'','".AddSlashes(pg_result($resaco,0,'pc29_solicitem'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($pc29_orcamitem=null,$pc29_solicitem=null) { 
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         $resac = pg_query("select nextval('db_acount_id_acount_seq') as acount");
         $acount = pg_result($resac,0,0);
         $resac = pg_query("insert into db_acountkey values($acount,6389,'$this->pc29_orcamitem','A')");
         $resac = pg_query("insert into db_acountkey values($acount,5516,'$this->pc29_solicitem','A')");
         if(isset($GLOBALS["HTTP_POST_VARS"]["pc29_orcamitem"]))
           $resac = pg_query("insert into db_acount values($acount,1045,6389,'".AddSlashes(pg_result($resaco,$conresaco,'pc29_orcamitem'))."','$this->pc29_orcamitem',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["pc29_solicitem"]))
           $resac = pg_query("insert into db_acount values($acount,1045,5516,'".AddSlashes(pg_result($resaco,$conresaco,'pc29_solicitem'))."','$this->pc29_solicitem',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = @pg_exec($sql);
     if($result==false){ 
   ...
   function excluir ($pc29_orcamitem=null,$pc29_solicitem=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         $resac = pg_query("select nextval('db_acount_id_acount_seq') as acount");
         $acount = pg_result($resac,0,0);
         $resac = pg_query("insert into db_acountkey values($acount,6389,'".pg_result($resaco,$iresaco,'pc29_orcamitem')."','E')");
         $resac = pg_query("insert into db_acountkey values($acount,5516,'".pg_result($resaco,$iresaco,'pc29_solicitem')."','E')");
         $resac = pg_query("insert into db_acount values($acount,1045,6389,'','".AddSlashes(pg_result($resaco,$iresaco,'pc29_orcamitem'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,1045,5516,'','".AddSlashes(pg_result($resaco,$iresaco,'pc29_solicitem'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
