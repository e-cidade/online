...
class cl_aidofautenticidade { 
   ...
   function incluir ($y01_sequencial){ 
     ...
     if($y01_sequencial == "" || $y01_sequencial == null ){
       $result = @pg_query("select nextval('aidofautenticidade_y01_sequencial_seq')"); 
       if($result==false){
       ...
       $result = @pg_query("select last_value from aidofautenticidade_y01_sequencial_seq");
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = pg_query("insert into db_acountkey values($acount,9614,'$this->y01_sequencial','I')");
       $resac = pg_query("insert into db_acount values($acount,1654,9614,'','".AddSlashes(pg_result($resaco,0,'y01_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,1654,9613,'','".AddSlashes(pg_result($resaco,0,'y01_aidof'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,1654,9612,'','".AddSlashes(pg_result($resaco,0,'y01_codautenticidade'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($y01_sequencial=null) { 
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         $resac = pg_query("select nextval('db_acount_id_acount_seq') as acount");
         $acount = pg_result($resac,0,0);
         $resac = pg_query("insert into db_acountkey values($acount,9614,'$this->y01_sequencial','A')");
         if(isset($GLOBALS["HTTP_POST_VARS"]["y01_sequencial"]))
           $resac = pg_query("insert into db_acount values($acount,1654,9614,'".AddSlashes(pg_result($resaco,$conresaco,'y01_sequencial'))."','$this->y01_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["y01_aidof"]))
           $resac = pg_query("insert into db_acount values($acount,1654,9613,'".AddSlashes(pg_result($resaco,$conresaco,'y01_aidof'))."','$this->y01_aidof',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["y01_codautenticidade"]))
           $resac = pg_query("insert into db_acount values($acount,1654,9612,'".AddSlashes(pg_result($resaco,$conresaco,'y01_codautenticidade'))."','$this->y01_codautenticidade',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = @pg_exec($sql);
     if($result==false){ 
   ...
   function excluir ($y01_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         $resac = pg_query("select nextval('db_acount_id_acount_seq') as acount");
         $acount = pg_result($resac,0,0);
         $resac = pg_query("insert into db_acountkey values($acount,9614,'$y01_sequencial','E')");
         $resac = pg_query("insert into db_acount values($acount,1654,9614,'','".AddSlashes(pg_result($resaco,$iresaco,'y01_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,1654,9613,'','".AddSlashes(pg_result($resaco,$iresaco,'y01_aidof'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,1654,9612,'','".AddSlashes(pg_result($resaco,$iresaco,'y01_codautenticidade'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
