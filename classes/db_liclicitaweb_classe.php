...
class cl_liclicitaweb { 
   ...
   function incluir ($l29_sequencial){ 
     ...
     if($l29_sequencial == "" || $l29_sequencial == null ){
       $result = @pg_query("select nextval('liclicitaweb_l29_sequencial_seq')"); 
       if($result==false){
       ...
       $result = @pg_query("select last_value from liclicitaweb_l29_sequencial_seq");
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = pg_query("insert into db_acountkey values($acount,9422,'$this->l29_sequencial','I')");
       $resac = pg_query("insert into db_acount values($acount,1618,9422,'','".AddSlashes(pg_result($resaco,0,'l29_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,1618,9428,'','".AddSlashes(pg_result($resaco,0,'l29_liclicita'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,1618,9423,'','".AddSlashes(pg_result($resaco,0,'l29_datapublic'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,1618,9424,'','".AddSlashes(pg_result($resaco,0,'l29_contato'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,1618,9426,'','".AddSlashes(pg_result($resaco,0,'l29_email'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,1618,9425,'','".AddSlashes(pg_result($resaco,0,'l29_telefone'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,1618,9427,'','".AddSlashes(pg_result($resaco,0,'l29_obs'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,1618,9414,'','".AddSlashes(pg_result($resaco,0,'l29_liberaedital'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($l29_sequencial=null) { 
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         $resac = pg_query("select nextval('db_acount_id_acount_seq') as acount");
         $acount = pg_result($resac,0,0);
         $resac = pg_query("insert into db_acountkey values($acount,9422,'$this->l29_sequencial','A')");
         if(isset($GLOBALS["HTTP_POST_VARS"]["l29_sequencial"]))
           $resac = pg_query("insert into db_acount values($acount,1618,9422,'".AddSlashes(pg_result($resaco,$conresaco,'l29_sequencial'))."','$this->l29_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["l29_liclicita"]))
           $resac = pg_query("insert into db_acount values($acount,1618,9428,'".AddSlashes(pg_result($resaco,$conresaco,'l29_liclicita'))."','$this->l29_liclicita',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["l29_datapublic"]))
           $resac = pg_query("insert into db_acount values($acount,1618,9423,'".AddSlashes(pg_result($resaco,$conresaco,'l29_datapublic'))."','$this->l29_datapublic',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["l29_contato"]))
           $resac = pg_query("insert into db_acount values($acount,1618,9424,'".AddSlashes(pg_result($resaco,$conresaco,'l29_contato'))."','$this->l29_contato',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["l29_email"]))
           $resac = pg_query("insert into db_acount values($acount,1618,9426,'".AddSlashes(pg_result($resaco,$conresaco,'l29_email'))."','$this->l29_email',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["l29_telefone"]))
           $resac = pg_query("insert into db_acount values($acount,1618,9425,'".AddSlashes(pg_result($resaco,$conresaco,'l29_telefone'))."','$this->l29_telefone',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["l29_obs"]))
           $resac = pg_query("insert into db_acount values($acount,1618,9427,'".AddSlashes(pg_result($resaco,$conresaco,'l29_obs'))."','$this->l29_obs',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["l29_liberaedital"]))
           $resac = pg_query("insert into db_acount values($acount,1618,9414,'".AddSlashes(pg_result($resaco,$conresaco,'l29_liberaedital'))."','$this->l29_liberaedital',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = @pg_exec($sql);
     if($result==false){ 
   ...
   function excluir ($l29_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         $resac = pg_query("select nextval('db_acount_id_acount_seq') as acount");
         $acount = pg_result($resac,0,0);
         $resac = pg_query("insert into db_acountkey values($acount,9422,'$l29_sequencial','E')");
         $resac = pg_query("insert into db_acount values($acount,1618,9422,'','".AddSlashes(pg_result($resaco,$iresaco,'l29_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,1618,9428,'','".AddSlashes(pg_result($resaco,$iresaco,'l29_liclicita'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,1618,9423,'','".AddSlashes(pg_result($resaco,$iresaco,'l29_datapublic'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,1618,9424,'','".AddSlashes(pg_result($resaco,$iresaco,'l29_contato'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,1618,9426,'','".AddSlashes(pg_result($resaco,$iresaco,'l29_email'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,1618,9425,'','".AddSlashes(pg_result($resaco,$iresaco,'l29_telefone'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,1618,9427,'','".AddSlashes(pg_result($resaco,$iresaco,'l29_obs'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,1618,9414,'','".AddSlashes(pg_result($resaco,$iresaco,'l29_liberaedital'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
