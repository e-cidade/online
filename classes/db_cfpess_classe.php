...
class cl_cfpess { 
   ...
   function alterar ($r11_anousu=null,$r11_mesusu=null,$r11_instit=null) { 
      $this->atualizacampos();
   ...
   function excluir ($r11_anousu=null,$r11_mesusu=null,$r11_instit=null,$dbwhere=null) { 
   ...
   // funcao do sql 
   function sql_query ( $r11_anousu=null,$r11_mesusu=null,$r11_instit=null,$campos="*",$ordem=null,$dbwhere=""){ 
     $sql = "select ";
     if($campos != "*" ){
   ...
   // funcao do sql 
   function sql_query_file ( $r11_anousu=null,$r11_mesusu=null,$r11_instit=null,$campos="*",$ordem=null,$dbwhere=""){ 
     $sql = "select ";
     if($campos != "*" ){
       $campos_sql = split("#",$campos);
       $virgula = "";
   ...
   */   
  function buscaCodigoRelatorio($sTipoRelatorio, $iAnoUsu, $iMesUsu) {
