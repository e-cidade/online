...
class cl_db_daitomadorpaga { 
   ...
   function incluir ($w09_sequencial){ 
     ...
     if($w09_sequencial == "" || $w09_sequencial == null ){
       $result = @pg_query("select nextval('db_daitomadorpaga_w09_sequencial_seq')"); 
       if($result==false){
       ...
       $result = @pg_query("select last_value from db_daitomadorpaga_w09_sequencial_seq");
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = pg_query("insert into db_acountkey values($acount,9120,'$this->w09_sequencial','I')");
       $resac = pg_query("insert into db_acount values($acount,1561,9120,'','".AddSlashes(pg_result($resaco,0,'w09_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,1561,9121,'','".AddSlashes(pg_result($resaco,0,'w09_daitomador'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,1561,9122,'','".AddSlashes(pg_result($resaco,0,'w09_dtpaga'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,1561,9123,'','".AddSlashes(pg_result($resaco,0,'w09_valpago'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($w09_sequencial=null) { 
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         $resac = pg_query("select nextval('db_acount_id_acount_seq') as acount");
         $acount = pg_result($resac,0,0);
         $resac = pg_query("insert into db_acountkey values($acount,9120,'$this->w09_sequencial','A')");
         if(isset($GLOBALS["HTTP_POST_VARS"]["w09_sequencial"]))
           $resac = pg_query("insert into db_acount values($acount,1561,9120,'".AddSlashes(pg_result($resaco,$conresaco,'w09_sequencial'))."','$this->w09_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["w09_daitomador"]))
           $resac = pg_query("insert into db_acount values($acount,1561,9121,'".AddSlashes(pg_result($resaco,$conresaco,'w09_daitomador'))."','$this->w09_daitomador',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["w09_dtpaga"]))
           $resac = pg_query("insert into db_acount values($acount,1561,9122,'".AddSlashes(pg_result($resaco,$conresaco,'w09_dtpaga'))."','$this->w09_dtpaga',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["w09_valpago"]))
           $resac = pg_query("insert into db_acount values($acount,1561,9123,'".AddSlashes(pg_result($resaco,$conresaco,'w09_valpago'))."','$this->w09_valpago',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = @pg_exec($sql);
     if($result==false){ 
   ...
   function excluir ($w09_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         $resac = pg_query("select nextval('db_acount_id_acount_seq') as acount");
         $acount = pg_result($resac,0,0);
         $resac = pg_query("insert into db_acountkey values($acount,9120,'$w09_sequencial','E')");
         $resac = pg_query("insert into db_acount values($acount,1561,9120,'','".AddSlashes(pg_result($resaco,$iresaco,'w09_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,1561,9121,'','".AddSlashes(pg_result($resaco,$iresaco,'w09_daitomador'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,1561,9122,'','".AddSlashes(pg_result($resaco,$iresaco,'w09_dtpaga'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,1561,9123,'','".AddSlashes(pg_result($resaco,$iresaco,'w09_valpago'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
   ...
   // funcao do sql 
   function sql_query ( $w09_sequencial=null,$campos="*",$ordem=null,$dbwhere=""){ 
     $sql = "select ";
     if($campos != "*" ){
     ...
     $sql .= " from db_daitomadorpaga ";
     $sql .= "      inner join db_daitomador  on  db_daitomador.w08_sequencial = db_daitomadorpaga.w09_daitomador";
     $sql .= "      inner join db_dae  on  db_dae.w04_codigo = db_daitomador.w08_dai";
     $sql2 = "";
     if($dbwhere==""){
       if($w09_sequencial!=null ){
         $sql2 .= " where db_daitomadorpaga.w09_sequencial = $w09_sequencial "; 
       } 
     }else if($dbwhere != ""){
       $sql2 = " where $dbwhere";
     }
   ...
   // funcao do sql 
   function sql_query_file ( $w09_sequencial=null,$campos="*",$ordem=null,$dbwhere=""){ 
     $sql = "select ";
     if($campos != "*" ){
       $campos_sql = split("#",$campos);
       $virgula = "";
