   ...
   function alterar ($x42_codmov=null) { 
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["x42_codmov"]))
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["x42_codsituacao"]))
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["x42_codcortemat"]))
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["x42_historico"]))
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["x42_data"]))
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["x42_usuario"]))
