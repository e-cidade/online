...
class cl_debcontapedidotipo { 
   ...
   function incluir ($d66_sequencial){ 
     ...
     if($d66_sequencial == "" || $d66_sequencial == null ){
       $result = @pg_query("select nextval('debcontapedidotipo_d66_sequencial_seq')"); 
       if($result==false){
       ...
       $result = @pg_query("select last_value from debcontapedidotipo_d66_sequencial_seq");
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = pg_query("insert into db_acountkey values($acount,7955,'$this->d66_sequencial','I')");
       $resac = pg_query("insert into db_acount values($acount,1333,7955,'','".AddSlashes(pg_result($resaco,0,'d66_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,1333,7957,'','".AddSlashes(pg_result($resaco,0,'d66_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,1333,7958,'','".AddSlashes(pg_result($resaco,0,'d66_arretipo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($d66_sequencial=null) { 
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         $resac = pg_query("select nextval('db_acount_id_acount_seq') as acount");
         $acount = pg_result($resac,0,0);
         $resac = pg_query("insert into db_acountkey values($acount,7955,'$this->d66_sequencial','A')");
         if(isset($GLOBALS["HTTP_POST_VARS"]["d66_sequencial"]))
           $resac = pg_query("insert into db_acount values($acount,1333,7955,'".AddSlashes(pg_result($resaco,$conresaco,'d66_sequencial'))."','$this->d66_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["d66_codigo"]))
           $resac = pg_query("insert into db_acount values($acount,1333,7957,'".AddSlashes(pg_result($resaco,$conresaco,'d66_codigo'))."','$this->d66_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["d66_arretipo"]))
           $resac = pg_query("insert into db_acount values($acount,1333,7958,'".AddSlashes(pg_result($resaco,$conresaco,'d66_arretipo'))."','$this->d66_arretipo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = @pg_exec($sql);
     if($result==false){ 
   ...
   function excluir ($d66_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         $resac = pg_query("select nextval('db_acount_id_acount_seq') as acount");
         $acount = pg_result($resac,0,0);
         $resac = pg_query("insert into db_acountkey values($acount,7955,'$d66_sequencial','E')");
         $resac = pg_query("insert into db_acount values($acount,1333,7955,'','".AddSlashes(pg_result($resaco,$iresaco,'d66_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,1333,7957,'','".AddSlashes(pg_result($resaco,$iresaco,'d66_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,1333,7958,'','".AddSlashes(pg_result($resaco,$iresaco,'d66_arretipo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
