...
class cl_itbiruralcaract { 
   ...
   function incluir ($it19_guia,$it19_codigo){ 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = pg_query("insert into db_acountkey values($acount,5847,'$this->it19_guia','I')");
       $resac = pg_query("insert into db_acountkey values($acount,5848,'$this->it19_codigo','I')");
       $resac = pg_query("insert into db_acount values($acount,936,5847,'','".AddSlashes(pg_result($resaco,0,'it19_guia'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,936,5848,'','".AddSlashes(pg_result($resaco,0,'it19_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,936,5849,'','".AddSlashes(pg_result($resaco,0,'it19_valor'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($it19_guia=null,$it19_codigo=null) { 
     ...
     $sql .= " where  it19_guia = $this->it19_guia
 and  it19_codigo = $this->it19_codigo
";
     $resaco = $this->sql_record($this->sql_query_file($this->it19_guia,$this->it19_codigo));
     if($this->numrows>0){       $resac = pg_query("select nextval('db_acount_id_acount_seq') as acount");
       $acount = pg_result($resac,0,0);
       $resac = pg_query("insert into db_acountkey values($acount,5847,'$this->it19_guia','A')");
       $resac = pg_query("insert into db_acountkey values($acount,5848,'$this->it19_codigo','A')");
       if(isset($GLOBALS["HTTP_POST_VARS"]["it19_guia"]))
         $resac = pg_query("insert into db_acount values($acount,936,5847,'".AddSlashes(pg_result($resaco,0,'it19_guia'))."','$this->it19_guia',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       if(isset($GLOBALS["HTTP_POST_VARS"]["it19_codigo"]))
         $resac = pg_query("insert into db_acount values($acount,936,5848,'".AddSlashes(pg_result($resaco,0,'it19_codigo'))."','$this->it19_codigo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       if(isset($GLOBALS["HTTP_POST_VARS"]["it19_valor"]))
         $resac = pg_query("insert into db_acount values($acount,936,5849,'".AddSlashes(pg_result($resaco,0,'it19_valor'))."','$this->it19_valor',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     $result = @pg_exec($sql);
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
   ...
   function excluir ($it19_guia=null,$it19_codigo=null) { 
     $resaco = $this->sql_record($this->sql_query_file($it19_guia,$it19_codigo));
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         $resac = pg_query("select nextval('db_acount_id_acount_seq') as acount");
         $acount = pg_result($resac,0,0);
         $resac = pg_query("insert into db_acountkey values($acount,5847,'".pg_result($resaco,$iresaco,'it19_guia')."','E')");
         $resac = pg_query("insert into db_acountkey values($acount,5848,'".pg_result($resaco,$iresaco,'it19_codigo')."','E')");
         $resac = pg_query("insert into db_acount values($acount,936,5847,'','".AddSlashes(pg_result($resaco,$iresaco,'it19_guia'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,936,5848,'','".AddSlashes(pg_result($resaco,$iresaco,'it19_codigo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,936,5849,'','".AddSlashes(pg_result($resaco,$iresaco,'it19_valor'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
