...
class cl_arrenumcgm { 
   ...
   function incluir ($k00_numcgm,$k00_numpre){ 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = pg_query("insert into db_acountkey values($acount,372,'$this->k00_numcgm','I')");
       $resac = pg_query("insert into db_acountkey values($acount,361,'$this->k00_numpre','I')");
       $resac = pg_query("insert into db_acount values($acount,511,372,'','".pg_result($resaco,0,'k00_numcgm')."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,511,361,'','".pg_result($resaco,0,'k00_numpre')."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($k00_numcgm=null,$k00_numpre=null) { 
     ...
     $sql .= " where  k00_numcgm = $this->k00_numcgm
 and  k00_numpre = $this->k00_numpre
";
     $resaco = $this->sql_record($this->sql_query_file($this->k00_numcgm,$this->k00_numpre));
     if($this->numrows>0){       $resac = pg_query("select nextval('db_acount_id_acount_seq') as acount");
       $acount = pg_result($resac,0,0);
       $resac = pg_query("insert into db_acountkey values($acount,372,'$this->k00_numcgm','A')");
       $resac = pg_query("insert into db_acountkey values($acount,361,'$this->k00_numpre','A')");
       if(isset($GLOBALS["HTTP_POST_VARS"]["k00_numcgm"]))
         $resac = pg_query("insert into db_acount values($acount,511,372,'".pg_result($resaco,0,'k00_numcgm')."','$this->k00_numcgm',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       if(isset($GLOBALS["HTTP_POST_VARS"]["k00_numpre"]))
         $resac = pg_query("insert into db_acount values($acount,511,361,'".pg_result($resaco,0,'k00_numpre')."','$this->k00_numpre',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     $result = @pg_exec($sql);
     if($result==false){ 
       $this->erro_banco = str_replace("\n","",@pg_last_error());
   ...
   function excluir ($k00_numcgm=null,$k00_numpre=null) { 
     $resaco = $this->sql_record($this->sql_query_file($k00_numcgm,$k00_numpre));
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         $resac = pg_query("select nextval('db_acount_id_acount_seq') as acount");
         $acount = pg_result($resac,0,0);
         $resac = pg_query("insert into db_acountkey values($acount,372,'".pg_result($resaco,$iresaco,'k00_numcgm')."','E')");
         $resac = pg_query("insert into db_acountkey values($acount,361,'".pg_result($resaco,$iresaco,'k00_numpre')."','E')");
         $resac = pg_query("insert into db_acount values($acount,511,372,'','".pg_result($resaco,$iresaco,'k00_numcgm')."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,511,361,'','".pg_result($resaco,$iresaco,'k00_numpre')."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
