...
class cl_ativid { 
   ...
   function incluir ($q03_ativ){ 
     ...
     if($this->q03_horaini == null ){ 
       $this->q03_horaini = null;
     }
     if($this->q03_horafim == null ){ 
       $this->q03_horafim = null;
     }
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = db_query("insert into db_acount values($acount,48,243,'','".AddSlashes(pg_result($resaco,0,'q03_ativ'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,48,244,'','".AddSlashes(pg_result($resaco,0,'q03_descr'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,48,245,'','".AddSlashes(pg_result($resaco,0,'q03_atmemo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,48,6853,'','".AddSlashes(pg_result($resaco,0,'q03_limite'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,48,12649,'','".AddSlashes(pg_result($resaco,0,'q03_horaini'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = db_query("insert into db_acount values($acount,48,12650,'','".AddSlashes(pg_result($resaco,0,'q03_horafim'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["q03_ativ"]) || $this->q03_ativ != "")
           $resac = db_query("insert into db_acount values($acount,48,243,'".AddSlashes(pg_result($resaco,$conresaco,'q03_ativ'))."','$this->q03_ativ',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["q03_descr"]) || $this->q03_descr != "")
           $resac = db_query("insert into db_acount values($acount,48,244,'".AddSlashes(pg_result($resaco,$conresaco,'q03_descr'))."','$this->q03_descr',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["q03_atmemo"]) || $this->q03_atmemo != "")
           $resac = db_query("insert into db_acount values($acount,48,245,'".AddSlashes(pg_result($resaco,$conresaco,'q03_atmemo'))."','$this->q03_atmemo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["q03_limite"]) || $this->q03_limite != "")
           $resac = db_query("insert into db_acount values($acount,48,6853,'".AddSlashes(pg_result($resaco,$conresaco,'q03_limite'))."','$this->q03_limite',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["q03_horaini"]) || $this->q03_horaini != "")
           $resac = db_query("insert into db_acount values($acount,48,12649,'".AddSlashes(pg_result($resaco,$conresaco,'q03_horaini'))."','$this->q03_horaini',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["q03_horafim"]) || $this->q03_horafim != "")
           $resac = db_query("insert into db_acount values($acount,48,12650,'".AddSlashes(pg_result($resaco,$conresaco,'q03_horafim'))."','$this->q03_horafim',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = db_query($sql);
     if($result==false){ 
   ...
   function excluir ($q03_ativ=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = db_query("insert into db_acount values($acount,48,243,'','".AddSlashes(pg_result($resaco,$iresaco,'q03_ativ'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,48,244,'','".AddSlashes(pg_result($resaco,$iresaco,'q03_descr'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,48,245,'','".AddSlashes(pg_result($resaco,$iresaco,'q03_atmemo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,48,6853,'','".AddSlashes(pg_result($resaco,$iresaco,'q03_limite'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,48,12649,'','".AddSlashes(pg_result($resaco,$iresaco,'q03_horaini'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,48,12650,'','".AddSlashes(pg_result($resaco,$iresaco,'q03_horafim'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
...
//     die($sql);
   ...
   function sql_query_cboSimulacao ($q03_ativ = null, $campos = "*", $ordem = null, $dbwhere = "") {
   	...
   	$sSql .= "   inner join clasativ      on clasativ.q82_ativ = ativid.q03_ativ          ";
   	$sSql .= "   inner join classe        on classe.q12_classe = clasativ.q82_classe      ";
   	$sSql .= "   left  join atividcbo     on atividcbo.q75_ativid = ativid.q03_ativ       ";
   	$sSql .= "   left  join rhcbo         on rhcbo.rh70_sequencial = atividcbo.q75_rhcbo  ";
