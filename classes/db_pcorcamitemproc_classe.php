...
class cl_pcorcamitemproc { 
   ...
   function incluir ($pc31_orcamitem,$pc31_pcprocitem){ 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = pg_query("insert into db_acountkey values($acount,6444,'$this->pc31_orcamitem','I')");
       $resac = pg_query("insert into db_acountkey values($acount,6445,'$this->pc31_pcprocitem','I')");
       $resac = pg_query("insert into db_acount values($acount,1044,6444,'','".AddSlashes(pg_result($resaco,0,'pc31_orcamitem'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,1044,6445,'','".AddSlashes(pg_result($resaco,0,'pc31_pcprocitem'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($pc31_orcamitem=null,$pc31_pcprocitem=null) { 
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         $resac = pg_query("select nextval('db_acount_id_acount_seq') as acount");
         $acount = pg_result($resac,0,0);
         $resac = pg_query("insert into db_acountkey values($acount,6444,'$this->pc31_orcamitem','A')");
         $resac = pg_query("insert into db_acountkey values($acount,6445,'$this->pc31_pcprocitem','A')");
         if(isset($GLOBALS["HTTP_POST_VARS"]["pc31_orcamitem"]))
           $resac = pg_query("insert into db_acount values($acount,1044,6444,'".AddSlashes(pg_result($resaco,$conresaco,'pc31_orcamitem'))."','$this->pc31_orcamitem',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["pc31_pcprocitem"]))
           $resac = pg_query("insert into db_acount values($acount,1044,6445,'".AddSlashes(pg_result($resaco,$conresaco,'pc31_pcprocitem'))."','$this->pc31_pcprocitem',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = @pg_exec($sql);
     if($result==false){ 
   ...
   function excluir ($pc31_orcamitem=null,$pc31_pcprocitem=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         $resac = pg_query("select nextval('db_acount_id_acount_seq') as acount");
         $acount = pg_result($resac,0,0);
         $resac = pg_query("insert into db_acountkey values($acount,6444,'".pg_result($resaco,$iresaco,'pc31_orcamitem')."','E')");
         $resac = pg_query("insert into db_acountkey values($acount,6445,'".pg_result($resaco,$iresaco,'pc31_pcprocitem')."','E')");
         $resac = pg_query("insert into db_acount values($acount,1044,6444,'','".AddSlashes(pg_result($resaco,$iresaco,'pc31_orcamitem'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,1044,6445,'','".AddSlashes(pg_result($resaco,$iresaco,'pc31_pcprocitem'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
   ...
   function sql_query_solicitem ( $pc31_orcamitem=null,$pc31_pcprocitem=null,$campos="*",$ordem=null,$dbwhere=""){ 
     ...
     $sql .= "      left join pcorcamval on pcorcamitem.pc22_orcamitem = pc23_orcamitem";
     ...
     $sql .= "      left  join empautitem  on  pcorcamitemproc.pc31_pcprocitem = empautitem.e55_sequen";
