...
class cl_db_ouvidoria { 
   ...
   var $campos = "
                 ...
                 po01_tipo = int4 = Categoria 
                 po01_datanascimento = date = Data de Nascimento 
                 po01_sexo = char(1) = Sexo 
   ...
   function atualizacampos($exclusao=false) {
     if($exclusao==false){
       ...
       $this->po01_datanascimento = ($this->po01_datanascimento == ""?@$GLOBALS["HTTP_POST_VARS"]["po01_datanascimento"]:$this->po01_datanascimento);
       $this->po01_sexo = ($this->po01_sexo == ""?@$GLOBALS["HTTP_POST_VARS"]["po01_sexo"]:$this->po01_sexo);
   ...
   function incluir ($po01_sequencial){ 
     ...
     $sql = "insert into db_ouvidoria(
                ...
                values (
                               ...
                               ,".($this->po01_sexo == "null" || $this->po01_sexo == ""?"null":"'".$this->po01_sexo."'")."
                               ,'$this->po01_profissao' 
