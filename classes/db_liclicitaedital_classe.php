...
class cl_liclicitaedital { 
   ...
   function incluir ($l27_sequencial){ 
     ...
     if($l27_sequencial == "" || $l27_sequencial == null ){
       $result = @pg_query("select nextval('liclicitaedital_l27_sequencial_seq')"); 
       if($result==false){
       ...
       $result = @pg_query("select last_value from liclicitaedital_l27_sequencial_seq");
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = pg_query("insert into db_acountkey values($acount,9410,'$this->l27_sequencial','I')");
       $resac = pg_query("insert into db_acount values($acount,1617,9410,'','".AddSlashes(pg_result($resaco,0,'l27_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,1617,9411,'','".AddSlashes(pg_result($resaco,0,'l27_arquivo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,1617,9429,'','".AddSlashes(pg_result($resaco,0,'l27_arqnome'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,1617,9413,'','".AddSlashes(pg_result($resaco,0,'l27_liclicita'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($l27_sequencial=null) { 
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         $resac = pg_query("select nextval('db_acount_id_acount_seq') as acount");
         $acount = pg_result($resac,0,0);
         $resac = pg_query("insert into db_acountkey values($acount,9410,'$this->l27_sequencial','A')");
         if(isset($GLOBALS["HTTP_POST_VARS"]["l27_sequencial"]))
           $resac = pg_query("insert into db_acount values($acount,1617,9410,'".AddSlashes(pg_result($resaco,$conresaco,'l27_sequencial'))."','$this->l27_sequencial',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["l27_arquivo"]))
           $resac = pg_query("insert into db_acount values($acount,1617,9411,'".AddSlashes(pg_result($resaco,$conresaco,'l27_arquivo'))."','$this->l27_arquivo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["l27_arqnome"]))
           $resac = pg_query("insert into db_acount values($acount,1617,9429,'".AddSlashes(pg_result($resaco,$conresaco,'l27_arqnome'))."','$this->l27_arqnome',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["l27_liclicita"]))
           $resac = pg_query("insert into db_acount values($acount,1617,9413,'".AddSlashes(pg_result($resaco,$conresaco,'l27_liclicita'))."','$this->l27_liclicita',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = @pg_exec($sql);
     if($result==false){ 
   ...
   function excluir ($l27_sequencial=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         $resac = pg_query("select nextval('db_acount_id_acount_seq') as acount");
         $acount = pg_result($resac,0,0);
         $resac = pg_query("insert into db_acountkey values($acount,9410,'$l27_sequencial','E')");
         $resac = pg_query("insert into db_acount values($acount,1617,9410,'','".AddSlashes(pg_result($resaco,$iresaco,'l27_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,1617,9411,'','".AddSlashes(pg_result($resaco,$iresaco,'l27_arquivo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,1617,9429,'','".AddSlashes(pg_result($resaco,$iresaco,'l27_arqnome'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,1617,9413,'','".AddSlashes(pg_result($resaco,$iresaco,'l27_liclicita'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
