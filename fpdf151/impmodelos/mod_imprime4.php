...
//$this->objpdf->text($xcol+17, $xlin+4,  date("d-m-Y",db_getsession("DB_datausu")));
//$this->objpdf->text($xcol+40, $xlin+4, 'Hora: '.date("H:i:s"));
...
$this->objpdf->text(104,$xlin+110,$this->nosso_numero);//   $this->dtvenc);
