...
//  $this->objpdf->Text($x+138, $y+30,str_pad($this->nosso_numero,17,"0",STR_PAD_LEFT));//   $this->nosso_numero);      // nosso numero
  $this->objpdf->Text($x+138, $y+30,$this->nosso_numero);//   $this->nosso_numero);      // nosso numero
...
// 	$this->objpdf->Text($x+141, $y+37,$this->valtotal);          // valor do documento
  ...
  $this->objpdf->Text($x+19,  $y+77,$this->descr11_1); // $this->nome);    // sacado 1
  $this->objpdf->Text($x+19,  $y+80,$this->descr11_2); // $this->ender);    // sacado 2

  $this->objpdf->Text($x+19,  $y+83,$this->munic." / ".$this->uf_config." / CEP-".$this->cep); // $this->munic);    // sacado 3
