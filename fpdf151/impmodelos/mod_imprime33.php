...
////////////////////////               for ($i = 0;$i < 2;$i++){
                ...
                $this->objpdf->roundedrect($xcol-2,$xlin-18,206,210.5,2,'DF','1234');
...
// ############# planilha de iss ######################
              ...
              // print_r($arr_prestador);exit;
                ...
                for( $xp=0; $xp < count( $arr_prestador )-1; $xp++ ){
                    ...
                    if( $coluna == 0 ){
                     //    $this->objpdf->cell(7,3,$arr_presador2[4],0,0,"L",0);
               ...
               // $this->objpdf->cell(100,3,"Resumo das notas:",0,1,"L",0);
                ...
                $this->objpdf->Roundedrect(125,$xlin+177,21,10,2,'DF','1234');
                ...
                $this->objpdf->text(175,$xlin+184,$this->numpre);
...
//////////////////////       }
               ...
               $this->objpdf->setfillcolor(245);
                $this->objpdf->roundedrect($xcol-2,$xlin-18,206,70.5,2,'DF','1234');
                $this->objpdf->setfillcolor(255,255,255);
//                $this->objpdf->roundedrect(10,07,190,183,2,'DF','1234');
                $this->objpdf->Setfont('Arial','B',11);
                $this->objpdf->text(150,$xlin-13,'RECIBO VÁLIDO ATÉ: ');
...
//                $this->objpdf->setfillcolor(245);
                ...
                $this->objpdf->Roundedrect(125,$xlin+27,21,10,2,'DF','1234');
                ...
                $this->objpdf->text(175,$xlin+34,$this->numpre);
...
//                $this->objpdf->TextWithDirection(1.5,$xlin+60,$this->texto . ' - ' . ($i == 1?'2ª VIA - CONTRIBUINTE':'1ª VIA - PREFEITURA'),'U'); // texto no canhoto do carne
                ...
                $this->objpdf->int25(10,$xlin+32,$this->codigobarras,15,0.341);
