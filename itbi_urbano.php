...
if (isset($pesquisa)){
	$sql="select * from cgm inner join iptubase on j01_numcgm=z01_numcgm where z01_cgccpf='$cnpj' and j01_matric = '$matricula'";   
	$result= pg_query($sql);
	$linhas=pg_num_rows($result);
	if($linhas>0){
		echo"
		<script>
			location.href='itbi_principalurbano.php?cnpj=$cnpj&mat=$matricula&tipo=urbano';
		</script>
		";
	}else{
...
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" bgcolor="<?=$w01_corbody?>" >
	<form name="form1" method="post" action="">
	    <table width="60%" border="0"  cellpadding="5" cellspacing="0" class="texto" align="center">
	        ...
	        <tr>
	            <td width="50%" height="30" align="right">Matricula:&nbsp;
	            </td>
	            <td width="50%" height="30"> <input name="matricula" type="text" size="14"  >
	            </td>
	        </tr>
	        <tr>
